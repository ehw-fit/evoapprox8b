...
%  EP = 97.5 %
  ...
  n34 = bitcmp(bitand(n22, bitand(n24, n10)));
  n39 = bitcmp(bitor(n26, bitor(n34, n10)));
  n41 = bitand(n2, n39);
  n45 = bitcmp(bitand(n20, n39));
  ...
  n275 = bitcmp(n197);
  n282 = bitand(n14, n18);
  n398 = bitor(bitand(n49, n264), bitand(bitcmp(n49), n148));
  n405 = n93;
