...
function [ c ] = mul8_330( a, b )
% Approximate function mul8_330
%  Library = EvoApprox8b
%  Circuit = mul8_330
%  Area   (180) = 6553
%  Delay  (180) = 4.480
...
%  EP = 94.7 %
  ...
  n38 = bitcmp(bitor(n24, bitor(n34, n26)));
  n39 = bitcmp(bitor(n24, bitor(n34, n26)));
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(bitor(n22, n16), n41));
  n49 = bitcmp(n46);
  n50 = bitcmp(bitand(n39, n16));
  n57 = bitand(n41, n46);
  n65 = n57;
  n82 = bitand(n6, n20);
  ...
  n121 = bitcmp(bitand(n65, bitand(n12, n22)));
  n132 = bitand(n12, n16);
  n148 = bitand(n14, n16);
  n181 = bitcmp(n121);
  n182 = bitand(n22, n0);
  n221 = bitxor(n49, n182);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
  n249 = bitand(n10, n18);
  n264 = bitand(n12, n18);
