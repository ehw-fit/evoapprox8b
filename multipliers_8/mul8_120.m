...
function [ c ] = mul8_120( a, b )
% Approximate function mul8_120
%  Library = EvoApprox8b
%  Circuit = mul8_120
%  Area   (180) = 7121
%  Delay  (180) = 3.020
...
%  EP = 98.5 %
  ...
  n32 = bitand(n18, n14);
  n33 = bitand(n18, n14);
  n35 = bitcmp(bitor(bitand(n20, n4), n32));
  n36 = bitxor(n26, n12);
  n37 = bitand(n26, n12);
  n38 = bitand(n33, n0);
  n41 = bitcmp(bitor(n2, n12));
  n42 = bitcmp(bitand(n18, bitand(n16, n14)));
  n46 = bitand(n2, n16);
  n49 = bitxor(n18, n12);
  n51 = n26;
  n54 = bitcmp(bitand(n49, n33));
  n55 = bitcmp(bitand(n49, n33));
  n56 = bitcmp(bitor(n2, n28));
  n62 = bitcmp(bitor(n22, n32));
  n63 = bitcmp(bitor(n22, n32));
  n65 = bitcmp(bitor(n28, n55));
  n67 = bitand(n14, n0);
  n68 = bitxor(bitxor(n18, n38), n56);
  n70 = bitcmp(bitor(n65, n42));
  n73 = bitcmp(bitor(n33, n54));
  n86 = bitcmp(bitand(n51, bitand(n0, n46)));
  n89 = bitcmp(bitand(n18, bitand(n70, n67)));
  n105 = bitor(n70, n12);
  n107 = bitand(n63, n56);
  n121 = bitand(n18, n70);
  ...
  n134 = bitand(n14, n16);
  n137 = bitand(n73, n12);
  n145 = bitcmp(bitand(bitor(n62, n54), n35));
  ...
  c = bitor(c, bitshift(bitand(n537, 1), 0));
