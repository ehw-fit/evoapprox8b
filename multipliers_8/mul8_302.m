...
function [ c ] = mul8_302( a, b )
% Approximate function mul8_302
%  Library = EvoApprox8b
%  Circuit = mul8_302
%  Area   (180) = 7041
%  Delay  (180) = 5.860
...
%  EP = 89.5 %
  ...
  n35 = bitcmp(bitand(bitor(n6, n4), n18));
  n38 = bitcmp(bitor(n33, n34));
  n39 = bitcmp(bitor(n33, n34));
  n46 = bitcmp(bitand(bitor(n30, n16), n8));
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  n93 = bitcmp(bitor(n82, n46));
  n114 = bitand(n10, n16);
  n118 = bitor(n39, n34);
  n132 = bitand(n12, n16);
  n148 = bitand(n14, n16);
  ...
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n304 = bitcmp(bitand(bitor(n249, n118), n35));
  ...
  n964 = bitcmp(bitand(n949, bitand(n12, n22)));
  n982 = bitand(n2, n24);
  n998 = bitand(n4, n24);
  n1014 = bitand(n6, n24);
  n1032 = bitand(n8, n24);
  ...
  c = bitor(c, bitshift(bitand(n304, 1), 3));
