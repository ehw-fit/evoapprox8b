...
function [ c ] = mul8_233( a, b )
% Approximate function mul8_233
%  Library = EvoApprox8b
%  Circuit = mul8_233
%  Area   (180) = 5601
%  Delay  (180) = 4.110
...
%  EP = 97.6 %
  ...
  n32 = bitand(n18, n12);
  n33 = bitand(n18, n12);
  n34 = bitcmp(bitand(n2, bitand(n32, n6)));
  n36 = bitcmp(bitor(n18, n34));
  n37 = bitcmp(bitor(n18, n34));
  n38 = bitcmp(bitor(n6, bitor(n34, n26)));
  n39 = bitcmp(bitor(n6, bitor(n34, n26)));
  n41 = bitand(n33, n30);
  n42 = bitcmp(bitand(bitor(n22, n16), n37));
  n43 = bitcmp(bitand(bitor(n22, n16), n37));
  n44 = bitxor(n42, n43);
  n47 = bitor(bitand(n44, n44), bitand(bitcmp(n44), n38));
  n49 = bitcmp(bitand(n41, n14));
  n51 = bitor(bitand(n2, n28), bitand(bitcmp(n2), n37));
  n54 = bitcmp(n49);
  n55 = bitcmp(n49);
  n58 = bitcmp(bitor(n47, n44));
  n62 = bitcmp(bitand(n54, bitand(n36, n26)));
  n64 = bitcmp(n62);
  n65 = bitcmp(n62);
  n72 = bitcmp(bitand(bitor(n65, n54), n51));
  n73 = bitcmp(bitand(bitor(n65, n54), n51));
  n77 = bitcmp(bitand(n18, bitand(n58, n6)));
  n78 = bitcmp(n55);
  n82 = bitand(n18, n37);
  n83 = bitand(n18, n37);
  n88 = bitand(n73, n78);
  n89 = bitand(n73, n78);
  n99 = bitor(bitand(n89, n72), bitand(bitcmp(n89), n43));
  n101 = bitcmp(bitand(bitor(n77, n82), n88));
  n103 = n101;
  n117 = n49;
  n121 = bitor(bitand(n51, n55), bitand(bitcmp(n51), n78));
  n123 = bitcmp(n121);
  n175 = bitcmp(bitor(n117, n64));
  ...
  c = bitor(c, bitshift(bitand(n1415, 1), 6));
