...
function [ c ] = mul8_444( a, b )
% Approximate function mul8_444
%  Library = EvoApprox8b
%  Circuit = mul8_444
%  Area   (180) = 6741
%  Delay  (180) = 4.830
...
%  EP = 95.8 %
  ...
  n40 = bitand(n18, n38);
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(bitor(n30, n4), n41));
  n49 = bitcmp(n46);
  n50 = bitcmp(bitor(bitand(n39, n16), n39));
  n57 = bitcmp(bitor(n41, n46));
  n69 = bitcmp(n41);
  n74 = bitxor(n22, n40);
  n77 = bitcmp(bitand(n49, n74));
  n82 = bitand(n6, n20);
  n94 = bitcmp(n77);
  n103 = bitcmp(bitand(bitor(n14, n50), n35));
  n114 = bitand(n103, n16);
  n132 = bitand(n94, n16);
  n148 = bitand(n14, n16);
  n182 = bitand(n57, n0);
  n221 = bitor(bitor(bitand(n49, n20), bitand(n20, n14)), bitand(n49, n14));
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  ...
  c = bitor(c, bitshift(bitand(n1315, 1), 2));
