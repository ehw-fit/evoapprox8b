...
function [ c ] = mul8_055( a, b )
% Approximate function mul8_055
%  Library = EvoApprox8b
%  Circuit = mul8_055
%  Area   (180) = 8544
%  Delay  (180) = 5.410
...
%  EP = 42.3 %
  ...
  n32 = bitand(n0, n16);
  n33 = bitand(n0, n16);
  n35 = bitcmp(bitor(n10, bitor(n0, n2)));
  n38 = bitcmp(bitor(n26, bitor(n28, n22)));
  n41 = bitcmp(bitand(n38, n28));
  n47 = bitor(bitand(n6, n26), bitand(bitcmp(n6), n41));
  n49 = bitand(n2, n16);
  n61 = bitcmp(bitand(n49, bitand(n12, n22)));
  n73 = bitcmp(bitor(n33, bitor(n47, n35)));
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  ...
  n164 = bitand(n0, n18);
  n169 = n49;
  n182 = bitcmp(bitand(n73, bitand(n18, n2)));
  n183 = bitcmp(bitand(n73, bitand(n18, n2)));
  n198 = bitand(n4, n18);
  n214 = bitand(n6, n18);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
  ...
  n315 = bitor(bitor(bitand(n299, n182), bitand(n182, n299)), bitand(n299, n299));
  ...
  n532 = bitand(n12, n20);
  n548 = bitand(n14, n20);
  n564 = bitor(bitand(n183, n432), bitand(bitcmp(n183), n61));
