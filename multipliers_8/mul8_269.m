...
%  EP = 97.9 %
  ...
  n32 = bitand(n18, n14);
  n33 = bitand(n18, n14);
  n34 = bitcmp(bitand(n10, bitand(n24, n2)));
  n37 = bitcmp(bitor(n18, n34));
  n38 = bitcmp(bitor(n10, bitor(n34, n26)));
  n39 = bitcmp(bitor(n10, bitor(n34, n26)));
  n41 = bitand(n2, n39);
  n43 = bitcmp(n37);
  n47 = bitcmp(bitor(bitand(n38, n26), n39));
  n50 = bitor(bitand(n14, n38), bitand(bitcmp(n14), n37));
  n51 = bitor(bitand(n14, n38), bitand(bitcmp(n14), n37));
  n53 = bitcmp(n37);
  n54 = bitcmp(n51);
  n57 = bitcmp(bitor(n41, n12));
  n59 = bitcmp(bitor(n53, n54));
  n60 = bitcmp(bitand(bitor(n53, n20), n59));
  n62 = bitcmp(bitand(n30, bitand(n50, n47)));
  n63 = bitcmp(bitand(n30, bitand(n50, n47)));
  n64 = bitcmp(bitxor(n62, n38));
  n71 = bitcmp(n43);
  n72 = bitcmp(bitand(bitor(n28, n28), n59));
  n81 = bitand(n18, n12);
  n83 = bitor(bitor(bitand(n18, n4), bitand(n4, n71)), bitand(n18, n71));
  n93 = bitcmp(bitand(n33, n20));
  n96 = bitcmp(bitand(n57, bitand(n14, n64)));
  n99 = bitcmp(bitand(n63, n60));
  n117 = bitcmp(n81);
  n123 = bitcmp(bitor(n117, n24));
  ...
  n1898 = bitxor(n915, n1764);
  n1899 = bitand(n915, n1764);
