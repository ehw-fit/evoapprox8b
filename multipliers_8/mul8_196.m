...
function [ c ] = mul8_196( a, b )
% Approximate function mul8_196
%  Library = EvoApprox8b
%  Circuit = mul8_196
%  Area   (180) = 6999
%  Delay  (180) = 5.400
...
%  EP = 91.3 %
  ...
  n51 = bitcmp(n39);
  n81 = bitcmp(bitor(n18, bitor(n38, n51)));
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  n107 = bitcmp(bitor(n81, n34));
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  n148 = bitand(n14, n16);
  n221 = bitor(n41, n114);
  ...
  n1114 = bitor(bitand(n1099, n982), bitand(bitcmp(n1099), n864));
  ...
  c = bitor(c, bitshift(bitand(n1014, 1), 1));
