...
function [ c ] = mul8_283( a, b )
% Approximate function mul8_283
%  Library = EvoApprox8b
%  Circuit = mul8_283
%  Area   (180) = 6577
%  Delay  (180) = 5.630
...
%  EP = 96.5 %
  ...
  n41 = bitand(n28, n38);
  n46 = bitcmp(bitand(bitor(n22, n16), n39));
  n47 = bitcmp(bitand(bitor(n22, n16), n39));
  ...
  n148 = bitand(n14, n16);
  n182 = bitand(n93, n8);
  n193 = bitcmp(bitand(n41, bitand(n134, n51)));
  n248 = bitand(n10, n18);
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n364 = bitcmp(n114);
  ...
  c = bitor(c, bitshift(bitand(n1549, 1), 4));
