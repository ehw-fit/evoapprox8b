...
function [ c ] = mul8_374( a, b )
% Approximate function mul8_374
%  Library = EvoApprox8b
%  Circuit = mul8_374
%  Area   (180) = 5569
%  Delay  (180) = 4.220
...
%  EP = 97.6 %
  ...
  n32 = bitand(n18, n12);
  n33 = bitand(n18, n12);
  n34 = bitcmp(bitand(n26, bitand(n32, n6)));
  n36 = bitcmp(bitor(n26, n34));
