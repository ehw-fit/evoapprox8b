...
%  EP = 99.0 %
  ...
  n950 = bitand(n12, n30);
  n964 = bitand(n14, n30);
  n1034 = bitcmp(bitxor(n921, n920));
  n1107 = n491;
  n1173 = bitor(n461, n564);
  ...
  n1246 = bitcmp(bitor(n26, n1034));
  n1335 = bitor(bitor(bitand(n817, n42), bitand(n42, n43)), bitand(n817, n43));
  ...
  n1869 = bitcmp(bitor(n761, n1034));
  n1882 = n1720;
  n1898 = bitor(n485, n890);
