...
function [ c ] = mul8_123( a, b )
% Approximate function mul8_123
%  Library = EvoApprox8b
%  Circuit = mul8_123
%  Area   (180) = 8412
%  Delay  (180) = 5.020
...
%  EP = 59.0 %
  ...
  n61 = bitcmp(bitand(n37, bitand(n6, n22)));
  n65 = bitand(n4, n54);
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n32);
  ...
  n164 = bitand(n0, n18);
  n169 = n49;
  n182 = bitcmp(bitand(n14, bitand(n18, n47)));
  n198 = bitand(n4, n18);
  n214 = bitand(n6, n18);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
  ...
  n348 = bitxor(bitxor(n98, n214), n55);
  n349 = bitor(bitor(bitand(n98, n214), bitand(n214, n55)), bitand(n98, n55));
