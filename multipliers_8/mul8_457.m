...
function [ c ] = mul8_457( a, b )
% Approximate function mul8_457
%  Library = EvoApprox8b
%  Circuit = mul8_457
%  Area   (180) = 7152
%  Delay  (180) = 5.610
...
%  EP = 91.6 %
  ...
  n51 = bitcmp(n39);
  n64 = bitcmp(bitor(n28, bitor(n12, n51)));
  ...
  n865 = bitor(bitor(bitand(n249, n732), bitand(n732, n849)), bitand(n249, n849));
  n881 = n665;
