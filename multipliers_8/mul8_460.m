...
function [ c ] = mul8_460( a, b )
% Approximate function mul8_460
%  Library = EvoApprox8b
%  Circuit = mul8_460
%  Area   (180) = 7792
%  Delay  (180) = 4.450
...
%  EP = 83.1 %
  ...
  n33 = bitand(n0, n12);
  n42 = bitcmp(bitxor(n6, n20));
  n43 = bitcmp(bitxor(n6, n20));
  n49 = bitand(n2, n16);
  n54 = bitcmp(bitor(n30, n42));
  n65 = bitand(n4, n54);
  n70 = n43;
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n16);
  ...
  n798 = bitand(n12, n22);
  n814 = bitand(n14, n22);
  n832 = bitxor(n582, n598);
  n848 = bitxor(n598, n714);
  n864 = bitxor(n614, n732);
  n865 = bitand(n614, n732);
  ...
  c = bitor(c, bitshift(bitand(n249, 1), 0));
