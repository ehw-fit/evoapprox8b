...
%  EP = 99.0 %
  ...
  n950 = bitand(n12, n30);
  n964 = bitand(n14, n30);
  n1034 = bitcmp(bitor(bitand(n921, n20), n41));
  n1107 = n491;
  ...
  n1542 = n157;
  n1543 = n157;
  n1586 = bitxor(bitxor(n1350, n624), n1408);
  n1587 = bitor(bitor(bitand(n1350, n624), bitand(n624, n1408)), bitand(n1350, n1408));
