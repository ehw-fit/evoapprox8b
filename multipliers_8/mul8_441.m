...
%  EP = 97.7 %
  ...
  n32 = bitand(n18, n14);
  n33 = bitand(n18, n14);
  n34 = bitcmp(bitand(n2, bitand(n28, n18)));
  n37 = bitcmp(bitor(n33, n34));
  n38 = bitcmp(bitor(n10, bitor(n34, n33)));
  n39 = bitcmp(bitor(n10, bitor(n34, n33)));
  n41 = bitand(n33, n28);
  n49 = n41;
  n51 = bitor(n49, n32);
  n54 = bitcmp(bitand(n49, n16));
  n60 = bitcmp(bitand(n2, bitand(n22, n30)));
  n61 = bitcmp(bitand(n2, bitand(n22, n30)));
  n66 = bitand(n37, n14);
  n83 = bitand(n18, n37);
  n86 = bitor(n54, n60);
  n89 = bitcmp(bitand(n18, n12));
  n99 = bitcmp(bitand(n14, n66));
  n113 = bitcmp(bitand(bitor(n89, n12), n51));
  n121 = bitcmp(bitand(n49, n54));
  n123 = bitcmp(n113);
  n235 = bitcmp(n99);
  n282 = bitor(bitand(n14, n18), bitand(bitcmp(n14), n39));
  n381 = bitcmp(bitor(n61, n86));
  n398 = n235;
  ...
  n682 = bitxor(bitxor(n415, n548), n381);
  n683 = bitor(bitor(bitand(n415, n548), bitand(n548, n381)), bitand(n415, n381));
  n749 = bitand(n6, n22);
  n764 = bitand(n8, n22);
  n782 = bitand(n10, n22);
  n798 = bitand(n12, n22);
  ...
  c = bitor(c, bitshift(bitand(n38, 1), 1));
