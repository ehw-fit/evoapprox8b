...
function [ c ] = mul8_CarrySaveArrayMultiplier_Using_CarrySelectAdder( a, b )
% Approximate function mul8_CarrySaveArrayMultiplier_Using_CarrySelectAdder
%  Library = EvoApprox8b
...
%  EP = 0.0 %
  ...
  n266 = bitxor(n254, n253);
  n267 = bitand(n254, n253);
  ...
  n272 = bitxor(n254, n253);
  n273 = bitand(n254, n253);
  n274 = bitcmp(n272);
  n276 = bitor(n273, n272);
  n278 = bitxor(bitxor(n256, n255), n276);
  n279 = bitor(bitor(bitand(n256, n255), bitand(n255, n276)), bitand(n256, n276));
  n280 = bitxor(bitxor(n242, n257), n279);
  n281 = bitor(bitor(bitand(n242, n257), bitand(n257, n279)), bitand(n242, n279));
  n282 = bitor(bitand(n265, n274), bitand(bitcmp(n265), n266));
  n284 = bitor(bitand(n265, n278), bitand(bitcmp(n265), n268));
  n286 = bitor(bitand(n265, n280), bitand(bitcmp(n265), n270));
  n288 = bitor(bitand(n265, n281), bitand(bitcmp(n265), n271));
  ...
  c = bitor(c, bitshift(bitand(n282, 1), 12));
  c = bitor(c, bitshift(bitand(n284, 1), 13));
  c = bitor(c, bitshift(bitand(n286, 1), 14));
  c = bitor(c, bitshift(bitand(n288, 1), 15));
end