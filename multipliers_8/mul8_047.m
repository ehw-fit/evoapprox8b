...
function [ c ] = mul8_047( a, b )
% Approximate function mul8_047
%  Library = EvoApprox8b
%  Circuit = mul8_047
%  Area   (180) = 5504
%  Delay  (180) = 4.210
...
%  EP = 97.9 %
  ...
  n32 = bitand(n18, n14);
  n34 = bitcmp(bitand(n10, bitand(n4, n2)));
  n37 = bitcmp(bitor(n12, n34));
  n38 = bitcmp(bitor(n10, n34));
  n39 = bitcmp(bitor(n10, n34));
  n41 = bitand(n18, n38);
  n42 = bitcmp(n37);
  n43 = bitcmp(n37);
  n49 = bitcmp(bitand(n41, n14));
  n54 = bitcmp(n49);
  n57 = bitand(n41, n12);
  n60 = bitcmp(bitand(n2, bitand(n54, n22)));
  n70 = bitcmp(bitor(n43, bitor(n60, n12)));
  n71 = bitcmp(bitor(n43, bitor(n60, n12)));
  n81 = bitand(n28, n39);
  n82 = bitand(n71, n38);
  n83 = bitand(n71, n38);
  n89 = bitcmp(bitand(n18, n54));
  n91 = bitor(bitand(n89, n54), bitand(bitcmp(n89), n71));
  n93 = bitcmp(bitand(n2, n82));
  n99 = bitcmp(bitor(bitand(n89, n16), n49));
  n102 = n99;
  n105 = bitcmp(bitand(n57, n71));
  n113 = bitor(n18, n14);
  n121 = bitcmp(bitand(n89, n38));
  n123 = bitcmp(bitand(n91, n24));
  n203 = bitcmp(bitand(n22, bitand(n42, n81)));
  n233 = bitcmp(bitand(n105, bitand(n70, n203)));
  n234 = bitcmp(bitor(n113, bitor(n102, n233)));
  n235 = bitcmp(bitor(n113, bitor(n102, n233)));
  n282 = bitor(bitand(n14, n18), bitand(bitcmp(n14), n57));
  n398 = n99;
  n399 = n99;
  ...
  n1898 = bitxor(n235, n1764);
  n1899 = bitand(n235, n1764);
  ...
  c = bitor(c, bitshift(bitand(n1197, 1), 4));
