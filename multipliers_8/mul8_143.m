...
function [ c ] = mul8_143( a, b )
% Approximate function mul8_143
%  Library = EvoApprox8b
%  Circuit = mul8_143
%  Area   (180) = 7015
%  Delay  (180) = 4.070
...
%  EP = 95.7 %
  ...
  n32 = bitcmp(bitor(n18, bitor(n12, n6)));
  n33 = bitcmp(bitor(n18, bitor(n12, n6)));
  n34 = bitxor(n6, n12);
  n38 = bitcmp(bitor(n6, bitor(n34, n24)));
  n41 = bitcmp(bitor(bitand(n2, n12), n6));
  n49 = bitcmp(bitor(n41, bitor(n38, n0)));
  n55 = bitand(n33, n32);
  n65 = bitcmp(bitand(n18, n55));
  n75 = bitor(n65, n0);
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  n108 = bitcmp(bitand(bitor(n49, n28), n75));
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  n148 = bitand(n14, n16);
  n232 = bitand(n8, n18);
