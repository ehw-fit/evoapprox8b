...
function [ c ] = mul8_112( a, b )
% Approximate function mul8_112
%  Library = EvoApprox8b
%  Circuit = mul8_112
%  Area   (180) = 5636
%  Delay  (180) = 3.990
...
%  EP = 97.8 %
  ...
  n36 = bitcmp(bitor(n10, n34));
  n37 = bitcmp(bitor(n10, n34));
  n38 = bitcmp(bitor(n10, n34));
  n41 = bitand(n18, n38);
  n43 = bitor(bitand(n26, n32), bitand(bitcmp(n26), n37));
  n46 = bitxor(n38, n36);
  n49 = bitcmp(bitand(n46, bitand(n14, n6)));
  n54 = bitcmp(n49);
  n57 = bitand(n41, n12);
  n63 = bitxor(n14, n20);
  n70 = bitcmp(bitor(n43, bitor(n8, n12)));
  n71 = bitcmp(bitor(n43, bitor(n8, n12)));
  n72 = bitand(n2, n28);
  n73 = bitand(n2, n28);
  n81 = bitand(n28, n38);
  n82 = bitand(n71, n38);
  ...
  n99 = bitcmp(bitor(bitand(n63, n16), n49));
  n102 = n99;
  n121 = bitcmp(bitand(n89, n38));
  n123 = bitcmp(bitand(n91, n24));
  n203 = bitcmp(bitor(bitand(n22, n38), n81));
  n233 = bitcmp(bitand(n73, bitand(n70, n203)));
