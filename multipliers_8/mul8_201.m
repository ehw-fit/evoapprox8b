...
function [ c ] = mul8_201( a, b )
% Approximate function mul8_201
%  Library = EvoApprox8b
%  Circuit = mul8_201
%  Area   (180) = 6703
%  Delay  (180) = 2.330
...
%  EP = 98.5 %
  ...
  n42 = bitcmp(bitor(n6, bitor(n4, n37)));
  ...
  n83 = bitand(n63, n60);
  n86 = n63;
  n88 = bitor(bitand(n51, n54), bitand(bitcmp(n51), n81));
  n89 = bitor(bitand(n51, n54), bitand(bitcmp(n51), n81));
