...
function [ c ] = mul8_266( a, b )
% Approximate function mul8_266
%  Library = EvoApprox8b
%  Circuit = mul8_266
%  Area   (180) = 9775
%  Delay  (180) = 2.840
...
%  EP = 96.3 %
  ...
  n33 = bitcmp(bitor(n18, bitor(n16, n0)));
  n34 = n18;
  n35 = n18;
  n37 = bitor(bitand(n14, n4), bitand(bitcmp(n14), n18));
  n38 = bitcmp(bitand(n18, bitand(n0, n30)));
  n39 = bitcmp(bitand(n18, bitand(n0, n30)));
  n41 = bitor(bitand(n0, n38), bitand(bitcmp(n0), n12));
  n43 = bitcmp(bitor(n30, n4));
  n44 = bitcmp(bitand(n41, n34));
  n45 = bitcmp(bitand(n41, n34));
  n46 = bitand(n2, n24);
  n50 = bitcmp(bitand(n6, n44));
  n53 = bitcmp(bitor(n33, bitor(n38, n39)));
  n54 = bitcmp(bitxor(n30, n0));
  n55 = bitcmp(bitxor(n30, n0));
  n57 = bitxor(n2, n46);
  n58 = bitcmp(n45);
  n59 = bitcmp(n45);
  n66 = bitcmp(bitor(n45, n58));
  n67 = bitcmp(bitor(n45, n58));
  n70 = bitcmp(bitor(bitand(n67, n4), n53));
  n71 = bitcmp(bitor(bitand(n67, n4), n53));
  n73 = bitand(n57, n54);
  n76 = bitand(n6, n16);
  n78 = n53;
  n81 = bitor(n18, n39);
  ...
  n109 = bitcmp(bitor(bitand(n18, n66), n43));
  n113 = bitand(n73, n12);
  n119 = bitcmp(bitxor(n41, n50));
  n121 = bitand(n12, n16);
  n134 = bitand(n14, n16);
  ...
  n169 = bitcmp(bitor(n28, n78));
  n200 = bitcmp(bitand(n94, bitand(n54, n59)));
  n202 = bitcmp(bitor(n45, bitor(n78, n2)));
  n206 = bitcmp(bitor(bitand(n10, n202), n39));
  n207 = bitcmp(bitor(bitand(n10, n202), n39));
  n208 = bitand(n73, n12);
  n224 = bitand(n10, n18);
  n238 = bitand(n12, n18);
  n249 = bitor(n105, n38);
  n255 = bitand(n14, n18);
  n268 = bitxor(bitxor(n26, n20), n119);
  n283 = bitand(n153, n20);
  n302 = bitand(n255, n136);
  n313 = bitand(n6, n20);
  n321 = bitand(n249, n150);
  n327 = n321;
  n328 = bitand(n8, n20);
  n329 = bitand(n8, n20);
  n342 = bitand(n10, n92);
  ...
  n830 = bitor(n55, n238);
  n832 = bitand(n12, n28);
  n838 = bitxor(n249, n830);
  n846 = bitand(n14, n28);
  n860 = bitand(n0, n30);
  n876 = bitand(n2, n30);
  n885 = bitcmp(bitand(bitor(n81, n302), n327));
  n890 = bitand(n4, n30);
  n906 = bitand(n6, n30);
  n920 = bitand(n8, n30);
  n934 = bitand(n10, n30);
  ...
  n1008 = n76;
  n1024 = bitxor(bitxor(n90, n742), n803);
  n1025 = bitor(bitor(bitand(n90, n742), bitand(n742, n803)), bitand(n90, n803));
  ...
  c = bitor(c, bitshift(bitand(n1737, 1), 0));
