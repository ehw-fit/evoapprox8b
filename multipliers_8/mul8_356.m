...
function [ c ] = mul8_356( a, b )
% Approximate function mul8_356
%  Library = EvoApprox8b
%  Circuit = mul8_356
%  Area   (180) = 6962
%  Delay  (180) = 3.190
...
%  EP = 98.5 %
  ...
  n32 = bitand(n18, n14);
  n33 = bitand(n18, n14);
  n36 = bitcmp(bitor(n26, bitor(n28, n14)));
  n37 = bitcmp(bitor(n26, bitor(n28, n14)));
  n39 = bitand(n22, n8);
  n41 = bitxor(n28, n28);
  n42 = bitcmp(bitand(n6, bitand(n16, n14)));
  n46 = bitand(n2, n16);
  n47 = bitand(n2, n16);
  n49 = bitor(n18, n12);
  n50 = bitcmp(bitand(n26, bitand(n20, n18)));
  n54 = bitcmp(bitand(n49, n33));
  n55 = bitcmp(bitand(n49, n33));
  n56 = bitcmp(bitor(n18, n28));
  n57 = bitcmp(bitor(n18, n28));
  n60 = bitor(bitand(n39, n4), bitand(bitcmp(n39), n37));
  n62 = bitor(bitand(n55, n32), bitand(bitcmp(n55), n22));
  n63 = bitor(bitand(n55, n32), bitand(bitcmp(n55), n22));
  n65 = bitcmp(bitor(n57, n55));
  n70 = bitcmp(bitor(n65, n42));
  n71 = bitcmp(bitor(n65, n42));
  n73 = bitcmp(bitor(n49, n54));
  n75 = bitor(bitand(n26, n60), bitand(bitcmp(n26), n41));
  n86 = bitcmp(bitand(n47, bitand(n24, n41)));
  n89 = n33;
  n105 = bitor(n70, n12);
  n106 = bitand(n63, n56);
  n107 = bitand(n63, n56);
  n113 = bitxor(n89, n71);
  n121 = bitand(n18, n62);
  n131 = bitor(bitor(bitand(n41, n4), bitand(n4, n107)), bitand(n41, n107));
  n134 = bitand(n14, n16);
  n137 = n73;
  n149 = bitcmp(bitand(bitor(n89, n20), n6));
  ...
  n234 = bitcmp(n223);
  n238 = bitand(n12, n18);
  n246 = bitcmp(bitor(n223, n50));
  n257 = bitcmp(bitor(n73, n86));
  n281 = bitcmp(bitxor(n137, n246));
  n310 = bitcmp(n149);
  n313 = bitor(bitand(n75, n86), bitand(bitcmp(n75), n113));
  n343 = bitand(n10, n20);
  n356 = bitand(n12, n20);
  n372 = bitand(n14, n20);
  ...
  n1023 = bitcmp(bitand(n281, n54));
  n1025 = bitor(n233, n54);
  ...
  c = bitor(c, bitshift(bitand(n313, 1), 0));
