...
function [ c ] = mul8_245( a, b )
% Approximate function mul8_245
%  Library = EvoApprox8b
%  Circuit = mul8_245
%  Area   (180) = 6084
%  Delay  (180) = 4.010
...
%  EP = 97.5 %
  ...
  n33 = bitcmp(bitand(n18, n14));
  n37 = bitcmp(bitor(n33, bitor(n22, n14)));
  n41 = bitand(n2, n28);
  n49 = bitcmp(bitand(n41, bitand(n14, n0)));
  n54 = bitcmp(n49);
  n65 = bitor(bitand(n6, n12), bitand(bitcmp(n6), n28));
  n83 = bitand(n18, n37);
  n86 = bitcmp(bitor(n65, n28));
  n89 = bitcmp(bitxor(n86, n28));
  n93 = n49;
  ...
  n275 = bitcmp(n197);
  n282 = bitand(n14, n18);
  n398 = bitor(bitand(n161, n264), bitand(bitcmp(n161), n148));
  n405 = n93;
  ...
  n532 = bitand(n12, n20);
  n548 = bitand(n14, n20);
  n632 = bitor(n425, n498);
  n633 = bitor(n425, n498);
