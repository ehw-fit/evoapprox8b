...
%  EP = 99.1 %
  ...
  n49 = bitcmp(bitor(bitand(n18, n12), n32));
  ...
  n65 = n41;
  n67 = n65;
  n68 = bitcmp(bitor(n65, bitor(n4, n67)));
  n69 = bitcmp(bitor(n65, bitor(n4, n67)));
  n70 = bitcmp(n69);
  n76 = bitcmp(bitand(n65, n70));
  n82 = bitcmp(bitor(n6, bitor(n4, n14)));
  n87 = bitor(n22, n24);
  n91 = bitcmp(bitor(n87, bitor(n28, n30)));
  n118 = bitand(n91, n20);
  ...
  n1202 = bitxor(bitxor(n1107, n854), n699);
  n1203 = bitor(bitor(bitand(n1107, n854), bitand(n854, n699)), bitand(n1107, n699));
  ...
  c = bitor(c, bitshift(bitand(n121, 1), 0));
