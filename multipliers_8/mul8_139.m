...
function [ c ] = mul8_139( a, b )
% Approximate function mul8_139
%  Library = EvoApprox8b
%  Circuit = mul8_139
%  Area   (180) = 7194
%  Delay  (180) = 3.950
...
%  EP = 92.9 %
  ...
  n34 = bitcmp(bitand(bitor(n6, n8), n18));
  n37 = bitcmp(bitand(n10, bitand(n6, n30)));
  n38 = bitcmp(bitor(n18, n34));
  n39 = bitcmp(bitor(n18, n34));
  n41 = bitor(bitor(bitand(n2, n38), bitand(n38, n22)), bitand(n2, n22));
  n45 = bitcmp(bitor(n26, bitor(n22, n30)));
  n51 = bitcmp(n39);
  n53 = bitcmp(n20);
  n58 = bitcmp(bitxor(n37, n38));
  n61 = bitcmp(n53);
  n64 = bitcmp(bitor(n18, bitor(n14, n51)));
  n65 = bitcmp(bitor(n18, bitor(n14, n51)));
  n77 = bitor(n37, n58);
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  n105 = n2;
  ...
  n137 = bitand(n12, n38);
  n148 = bitand(n14, n16);
  n166 = bitcmp(bitand(bitor(n117, n108), n105));
  n182 = bitand(n22, n64);
  n195 = bitcmp(bitand(n108, n166));
  n211 = bitcmp(n51);
  n221 = bitor(n41, n82);
  n248 = bitand(n10, n18);
  n258 = bitcmp(bitand(n195, n64));
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n339 = bitcmp(bitor(n77, bitor(n8, n37)));
  ...
  n1099 = bitand(n549, n258);
  n1114 = bitxor(bitxor(n137, n982), n1099);
