...
%  EP = 91.4 %
  ...
  n81 = bitcmp(bitor(bitand(n18, n39), n51));
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  n107 = bitcmp(bitor(n81, n82));
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  n136 = bitxor(n12, n38);
  n137 = bitand(n12, n38);
  ...
  n148 = bitand(n14, n16);
  n182 = bitand(n22, n64);
  n190 = bitcmp(bitxor(n10, n8));
  n211 = bitcmp(n51);
  n217 = bitcmp(bitor(bitand(n18, n190), n139));
  n221 = bitor(n41, n114);
  n233 = bitand(n8, n18);
  n248 = bitand(n10, n18);
  n264 = bitand(n12, n18);
  ...
  n865 = bitor(bitor(bitand(n233, n732), bitand(n732, n849)), bitand(n233, n849));
  n881 = n665;
