...
function [ c ] = mul8_216( a, b )
% Approximate function mul8_216
%  Library = EvoApprox8b
%  Circuit = mul8_216
%  Area   (180) = 6617
%  Delay  (180) = 5.740
...
%  EP = 96.2 %
  ...
  n38 = bitcmp(bitor(n14, bitor(n34, n4)));
  n39 = bitcmp(bitor(n14, bitor(n34, n4)));
  n41 = bitand(n18, n39);
  n46 = bitcmp(bitand(bitor(n18, n16), n39));
  n47 = bitcmp(bitand(bitor(n18, n16), n39));
  n48 = bitcmp(bitor(n46, bitor(n14, n6)));
  n49 = bitcmp(bitor(n46, bitor(n14, n6)));
  n50 = bitcmp(bitor(bitand(n39, n0), n39));
  n64 = bitand(n41, n38);
  n67 = bitcmp(bitand(n47, bitand(n28, n41)));
  n69 = bitcmp(n41);
  n74 = bitcmp(bitor(n47, bitor(n18, n39)));
  n77 = bitcmp(bitand(n41, n74));
  n86 = bitand(n33, n48);
  n93 = bitcmp(bitor(n10, n50));
  n94 = bitcmp(bitor(bitand(n77, n67), n93));
  n102 = bitcmp(bitand(bitor(n26, n50), n35));
  n103 = bitcmp(bitand(bitor(n26, n50), n35));
  n114 = bitand(n103, n64);
  n115 = bitand(n103, n64);
  n132 = bitand(n94, n16);
  n148 = bitand(n14, n16);
  n182 = bitand(n93, n8);
  n221 = n49;
  ...
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n364 = bitcmp(bitor(bitand(n114, n232), n115));
  n365 = bitcmp(bitor(bitand(n114, n232), n115));
  ...
  n548 = bitand(n14, n20);
  n586 = bitcmp(n69);
  n614 = bitor(n364, n586);
  n632 = bitxor(n382, n102);
  n633 = bitand(n382, n102);
  ...
  c = bitor(c, bitshift(bitand(n1498, 1), 5));
