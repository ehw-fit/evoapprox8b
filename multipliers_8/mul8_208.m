...
function [ c ] = mul8_208( a, b )
% Approximate function mul8_208
%  Library = EvoApprox8b
%  Circuit = mul8_208
%  Area   (180) = 8411
%  Delay  (180) = 3.520
...
%  EP = 96.6 %
  ...
  n32 = bitand(n18, n12);
  n34 = bitcmp(bitand(n30, bitand(n0, n26)));
  n35 = bitcmp(bitand(n30, bitand(n0, n26)));
  n38 = bitcmp(bitor(bitand(n22, n24), n35));
  n41 = bitand(n12, n38);
  n46 = bitcmp(bitor(bitand(n2, n16), n34));
  n47 = bitcmp(bitor(bitand(n2, n16), n34));
  ...
  n70 = n18;
  n76 = bitand(n6, n16);
  n86 = bitcmp(bitand(bitor(n18, n4), n67));
  n87 = bitcmp(bitand(bitor(n18, n4), n67));
  n89 = bitor(bitand(n35, n38), bitand(bitcmp(n35), n65));
  n90 = bitand(n2, n64);
  n92 = bitcmp(bitxor(n57, n66));
  n99 = bitor(bitand(n87, n8), bitand(bitcmp(n87), n18));
  n102 = bitor(n59, n70);
  ...
  n357 = bitand(n12, n20);
  n372 = bitand(n14, n20);
  n402 = bitcmp(bitand(n107, bitand(n86, n2)));
