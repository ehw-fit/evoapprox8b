...
function [ c ] = mul8_410( a, b )
% Approximate function mul8_410
%  Library = EvoApprox8b
%  Circuit = mul8_410
%  Area   (180) = 5960
%  Delay  (180) = 3.880
...
%  EP = 97.8 %
  ...
  n32 = bitcmp(bitand(n18, bitand(n12, n0)));
  n33 = bitcmp(bitand(n18, bitand(n12, n0)));
  n34 = bitor(bitand(n22, n16), bitand(bitcmp(n22), n18));
  n39 = bitcmp(bitor(n22, bitor(n34, n2)));
  n41 = bitand(n18, n39);
  n42 = bitcmp(bitor(n33, n24));
  n46 = n26;
  n49 = bitcmp(bitand(n46, bitand(n14, n6)));
  n51 = bitor(n41, n32);
  n54 = bitcmp(bitor(n33, n42));
  n57 = n33;
  n61 = bitcmp(n49);
  ...
  n77 = n61;
  n83 = bitand(n39, n76);
  n97 = bitcmp(bitor(n57, n14));
  n121 = bitand(n97, n54);
  n146 = bitcmp(bitor(bitand(n83, n51), n121));
  n225 = n73;
  n243 = bitor(bitand(n225, n146), bitand(bitcmp(n225), n121));
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n377 = n41;
  n398 = bitxor(n77, n264);
  n399 = bitand(n77, n264);
  ...
  n1398 = bitxor(bitxor(n1148, n1264), n243);
  n1399 = bitor(bitor(bitand(n1148, n1264), bitand(n1264, n243)), bitand(n1148, n243));
