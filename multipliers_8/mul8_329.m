...
function [ c ] = mul8_329( a, b )
% Approximate function mul8_329
%  Library = EvoApprox8b
%  Circuit = mul8_329
%  Area   (180) = 5792
%  Delay  (180) = 3.830
...
%  EP = 97.8 %
  ...
  n32 = bitand(n18, n12);
  n33 = bitand(n18, n12);
  n34 = bitcmp(bitand(n10, bitand(n4, n24)));
  ...
  n42 = bitcmp(n37);
  n43 = bitcmp(n37);
  n49 = bitcmp(bitand(n41, bitand(n14, n0)));
  n51 = bitor(n43, n34);
  n57 = bitand(n41, n12);
  n59 = bitxor(n51, n20);
  n60 = bitcmp(bitand(n33, bitand(n39, n22)));
  n62 = bitcmp(n14);
  n63 = bitcmp(n14);
  n68 = bitand(n37, n43);
  ...
  n72 = bitand(n2, n28);
  n73 = bitand(n2, n28);
  n76 = bitcmp(bitand(n2, bitand(n20, n59)));
  n77 = bitcmp(bitand(n2, bitand(n20, n59)));
  n81 = bitand(n28, n38);
  n82 = bitand(n71, n38);
  n83 = bitand(n71, n38);
  n89 = bitcmp(bitand(n18, n28));
  n91 = bitxor(n81, n68);
  n93 = bitcmp(bitand(n2, n82));
  n95 = bitcmp(bitor(n77, bitor(n76, n42)));
  n99 = bitcmp(bitor(bitand(n63, n38), n49));
  n102 = n99;
  ...
  n163 = n95;
  n233 = bitcmp(n73);
  n235 = bitcmp(bitor(n99, bitor(n102, n233)));
  n282 = bitor(bitand(n14, n18), bitand(bitcmp(n14), n57));
  n393 = bitand(n121, n62);
  n398 = n99;
