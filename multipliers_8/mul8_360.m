...
function [ c ] = mul8_360( a, b )
% Approximate function mul8_360
%  Library = EvoApprox8b
%  Circuit = mul8_360
%  Area   (180) = 5377
%  Delay  (180) = 2.380
...
%  EP = 99.1 %
  ...
  n66 = n65;
  n67 = n65;
  n68 = bitcmp(bitor(n10, n66));
  n69 = bitcmp(bitor(n10, n66));
  n71 = bitcmp(n69);
  n73 = bitand(n65, n46);
  ...
  n118 = bitor(bitand(n43, n20), bitand(bitcmp(n43), n40));
  n119 = bitor(bitand(n43, n20), bitand(bitcmp(n43), n40));
  n120 = bitand(n12, n118);
  n121 = bitand(n12, n118);
  n132 = bitcmp(bitor(bitand(n26, n28), n71));
  n134 = bitxor(n37, n132);
  n137 = bitor(bitand(n51, n119), bitand(bitcmp(n51), n73));
