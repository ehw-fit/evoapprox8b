...
function [ c ] = mul8_343( a, b )
% Approximate function mul8_343
%  Library = EvoApprox8b
%  Circuit = mul8_343
%  Area   (180) = 6505
%  Delay  (180) = 5.760
...
%  EP = 96.2 %
  ...
  n64 = bitcmp(bitand(n41, bitand(n38, n48)));
  n69 = bitcmp(n41);
  n86 = bitand(n33, n48);
  ...
  n121 = bitcmp(bitor(bitand(n2, n102), n115));
  n148 = bitand(n14, n16);
  n181 = bitcmp(n121);
  n182 = bitand(n93, n8);
  n221 = n93;
  ...
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n364 = bitcmp(bitxor(n114, n232));
  n365 = bitcmp(bitxor(n114, n232));
  n382 = bitor(n181, n248);
