...
function [ c ] = mul8_083( a, b )
% Approximate function mul8_083
%  Library = EvoApprox8b
%  Circuit = mul8_083
%  Area   (180) = 8396
%  Delay  (180) = 5.280
...
%  EP = 74.2 %
  ...
  n60 = bitcmp(bitand(n2, bitand(n6, n22)));
  n65 = bitand(n4, n54);
  n81 = n18;
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n20);
  ...
  n332 = bitxor(bitxor(n82, n106), n315);
