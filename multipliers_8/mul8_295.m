...
function [ c ] = mul8_295( a, b )
% Approximate function mul8_295
%  Library = EvoApprox8b
%  Circuit = mul8_295
%  Area   (180) = 6852
%  Delay  (180) = 5.240
...
%  EP = 96.4 %
  ...
  n38 = bitcmp(bitor(n10, bitor(n34, n18)));
  n39 = bitcmp(bitor(n10, bitor(n34, n18)));
  n41 = bitand(n2, n38);
  n46 = bitcmp(bitand(bitor(n26, n16), n41));
  n47 = bitcmp(bitand(bitor(n26, n16), n41));
  n48 = bitcmp(bitor(n46, bitor(n14, n0)));
  n49 = bitcmp(bitor(n46, bitor(n14, n0)));
  n50 = bitcmp(n39);
  n51 = bitcmp(n39);
  n57 = bitcmp(n41);
  n67 = bitcmp(bitand(bitor(n47, n48), n41));
  n68 = bitcmp(n41);
  n69 = bitcmp(n41);
  n82 = bitcmp(bitor(n6, bitor(n20, n67)));
  n86 = bitand(n51, n48);
  n93 = bitcmp(bitor(n10, n46));
  n94 = bitcmp(bitand(bitor(n10, n68), n67));
  n102 = bitcmp(bitor(n26, n50));
  n103 = bitcmp(bitor(n26, n50));
  n105 = bitcmp(bitxor(n18, n86));
  n114 = bitand(n103, n50);
  n115 = bitand(n103, n50);
  n129 = bitand(n105, n12);
  n132 = bitand(n94, n16);
  n134 = bitor(n69, n114);
  n148 = bitand(n14, n16);
  n153 = n129;
  ...
  n1114 = bitxor(bitxor(n67, n982), n1099);
  n1132 = bitor(bitand(n1099, n998), bitand(bitcmp(n1099), n193));
