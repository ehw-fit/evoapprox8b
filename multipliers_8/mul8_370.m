...
%  EP = 97.7 %
  ...
  n54 = bitcmp(n49);
  n55 = bitcmp(n49);
  n61 = bitcmp(bitand(bitor(n2, n4), n22));
  n62 = bitcmp(n37);
  n63 = bitcmp(n37);
  n69 = bitcmp(bitor(n26, n62));
  n82 = bitand(n10, n16);
  n85 = bitcmp(bitand(n61, n54));
  n89 = bitcmp(bitand(n41, n63));
  n93 = bitcmp(bitand(n85, n82));
  n99 = bitcmp(n63);
  n102 = bitxor(n99, n62);
  n116 = bitcmp(bitand(n69, bitand(n62, n55)));
  n117 = bitcmp(bitand(n69, bitand(n62, n55)));
  n123 = bitcmp(bitor(n117, n12));
  n189 = bitcmp(n2);
  n235 = bitcmp(bitor(n99, bitor(n102, n189)));
  n282 = bitor(bitand(n14, n18), bitand(bitcmp(n14), n39));
  n398 = bitand(n99, n116);
  n399 = bitand(n99, n116);
  ...
  c = bitor(c, bitshift(bitand(n515, 1), 2));
