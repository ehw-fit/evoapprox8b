...
%  EP = 98.8 %
  ...
  n36 = bitand(n2, n28);
  n37 = bitand(n2, n28);
  n38 = bitcmp(bitand(n37, bitand(n24, n22)));
  n41 = bitor(n28, n38);
  n48 = bitcmp(bitand(n18, n12));
  n51 = bitand(n30, n0);
  n54 = bitcmp(bitand(n22, bitand(n12, n18)));
  n62 = bitand(n51, n36);
  n63 = bitand(n51, n36);
  ...
  n964 = bitand(n14, n30);
  n965 = bitand(n14, n30);
  n980 = bitor(n965, n150);
  n1068 = bitxor(bitxor(n134, n238), n335);
  n1069 = bitor(bitor(bitand(n134, n238), bitand(n238, n335)), bitand(n134, n335));
  n1082 = bitand(n254, n356);
  n1098 = bitxor(n773, n356);
  ...
  c = bitor(c, bitshift(bitand(n393, 1), 0));
  c = bitor(c, bitshift(bitand(n980, 1), 1));
  c = bitor(c, bitshift(bitand(n1587, 1), 2));
  ...
  c = bitor(c, bitshift(bitand(n1572, 1), 7));
