...
function [ c ] = mul8_013( a, b )
% Approximate function mul8_013
%  Library = EvoApprox8b
%  Circuit = mul8_013
%  Area   (180) = 10071
%  Delay  (180) = 2.860
...
%  EP = 87.5 %
  ...
  n32 = bitand(n0, n16);
  n33 = bitand(n0, n16);
  n34 = bitcmp(bitxor(n10, n12));
  n35 = bitcmp(bitxor(n10, n12));
  n37 = bitand(n28, n12);
  n38 = bitxor(bitxor(n37, n0), n14);
  n41 = bitcmp(bitand(n33, n14));
  n46 = bitand(n2, n16);
  n51 = bitxor(n14, n32);
  n57 = bitcmp(bitor(n41, bitor(n30, n6)));
  n60 = bitand(n4, n16);
  n61 = bitand(n4, n16);
  n62 = bitcmp(bitand(bitor(n57, n20), n61));
  n66 = bitcmp(bitand(n8, bitand(n4, n61)));
  n70 = bitcmp(bitor(n51, bitor(n66, n2)));
  n73 = bitxor(n33, n38);
  n74 = bitcmp(bitor(n30, n34));
  n76 = bitand(n6, n70);
  n81 = bitcmp(bitor(n41, n14));
  n89 = bitcmp(n33);
  n90 = bitand(n8, n16);
  n93 = bitcmp(bitand(n57, n62));
  n94 = bitor(n73, n38);
  n101 = bitcmp(bitand(n93, bitand(n90, n14)));
  n106 = bitand(n10, n16);
  n121 = bitand(n12, n16);
  n126 = bitcmp(bitand(n101, n60));
  n128 = n41;
  n134 = bitand(n14, n16);
  n150 = bitand(n0, n18);
  n153 = bitcmp(bitor(bitand(n33, n134), n51));
  n160 = n126;
  n164 = bitand(n2, n18);
  n166 = bitcmp(bitxor(n37, n128));
  n180 = bitand(n4, n18);
  n187 = bitcmp(bitor(bitand(n35, n166), n81));
  n194 = bitand(n6, n18);
  n198 = bitand(n153, n38);
  n224 = bitand(n10, n18);
  n233 = bitcmp(bitor(n94, bitor(n198, n22)));
  n238 = bitand(n12, n18);
  n254 = bitand(n14, n18);
  n265 = bitor(n18, n38);
  n268 = bitand(n0, n20);
  n275 = bitcmp(bitor(n233, n160));
  n280 = bitcmp(bitor(n89, bitor(n150, n187)));
  n282 = bitand(n2, n20);
  n283 = bitand(n2, n20);
  n298 = bitand(n4, n20);
  n328 = bitand(n8, n20);
  n343 = bitand(n10, n20);
  n356 = bitand(n12, n282);
  n358 = bitcmp(bitxor(n57, n90));
  n372 = bitand(n14, n20);
  n386 = bitand(n0, n22);
  ...
  n491 = bitand(n14, n22);
  n506 = bitand(n0, n24);
  n513 = bitor(bitand(n275, n358), bitand(bitcmp(n275), n265));
  n520 = bitand(n2, n24);
  n534 = bitand(n4, n24);
  n550 = bitand(n6, n24);
  n564 = bitand(n8, n24);
  ...
  n1008 = bitand(n76, n180);
  n1009 = bitand(n76, n180);
  ...
  n1128 = bitxor(bitxor(n417, n520), n624);
  n1129 = bitor(bitor(bitand(n417, n520), bitand(n520, n624)), bitand(n417, n624));
  n1142 = bitand(n432, n534);
  ...
  n1883 = bitor(bitor(bitand(n1720, n1707), bitand(n1707, n1869)), bitand(n1720, n1869));
  n1898 = bitxor(bitxor(n1734, n1721), n1883);
  n1899 = bitor(bitor(bitand(n1734, n1721), bitand(n1721, n1883)), bitand(n1734, n1883));
  n1912 = bitxor(bitxor(n1750, n1735), n1899);
  n1928 = bitxor(bitxor(n1764, n1751), n1747);
  n1929 = bitor(bitor(bitand(n1764, n1751), bitand(n1751, n1747)), bitand(n1764, n1747));
