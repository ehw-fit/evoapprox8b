...
function [ c ] = mul8_493( a, b )
% Approximate function mul8_493
%  Library = EvoApprox8b
%  Circuit = mul8_493
%  Area   (180) = 7356
%  Delay  (180) = 3.520
...
%  EP = 96.8 %
  ...
  n138 = n41;
  n139 = n41;
  n141 = bitcmp(bitor(n26, bitor(n70, n55)));
  ...
  n964 = bitand(n14, n30);
  n980 = n46;
  n1009 = bitor(bitand(n83, n566), bitand(bitcmp(n83), n76));
  ...
  n1720 = bitxor(n1556, n1543);
  n1721 = bitand(n1556, n1543);
