...
function [ c ] = mul8_145( a, b )
% Approximate function mul8_145
%  Library = EvoApprox8b
%  Circuit = mul8_145
%  Area   (180) = 7240
%  Delay  (180) = 4.490
...
%  EP = 91.3 %
  ...
  n132 = bitand(n12, n16);
  n137 = bitand(n12, n38);
  n148 = bitand(n14, n114);
  n182 = bitand(n22, n64);
  n190 = bitor(bitand(n137, n8), bitand(bitcmp(n137), n10));
  n211 = bitcmp(n51);
  n217 = bitand(n65, n190);
  n221 = bitor(n41, n114);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
  n264 = bitand(n12, n18);
