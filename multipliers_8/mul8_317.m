...
function [ c ] = mul8_317( a, b )
% Approximate function mul8_317
%  Library = EvoApprox8b
%  Circuit = mul8_317
%  Area   (180) = 7038
%  Delay  (180) = 4.200
...
%  EP = 94.7 %
  ...
  n38 = bitcmp(bitor(n10, n12));
  n57 = bitor(n2, n28);
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  n107 = bitcmp(bitor(n22, n34));
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  n148 = bitand(n14, n16);
  n176 = bitcmp(bitand(bitor(n57, n38), n83));
  n232 = bitand(n33, n18);
  n248 = bitand(n10, n18);
  n249 = bitand(n10, n18);
  n264 = bitand(n12, n18);
