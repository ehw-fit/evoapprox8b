...
%  EP = 97.2 %
  ...
  n32 = bitcmp(bitand(n18, bitand(n12, n6)));
  n33 = bitcmp(bitand(n18, bitand(n12, n6)));
  n36 = bitcmp(bitor(n20, n14));
  n39 = bitcmp(bitor(n10, bitor(n32, n6)));
  n41 = bitand(n2, n39);
  n54 = bitcmp(bitor(n33, n12));
  n83 = bitand(n39, n0);
  n89 = bitcmp(bitor(n2, bitor(n39, n6)));
  n99 = bitor(bitor(bitand(n89, n36), bitand(n36, n30)), bitand(n89, n30));
  n251 = bitcmp(n99);
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n377 = n41;
  n399 = bitand(n251, n264);
