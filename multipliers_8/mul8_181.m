...
function [ c ] = mul8_181( a, b )
% Approximate function mul8_181
%  Library = EvoApprox8b
%  Circuit = mul8_181
%  Area   (180) = 6464
%  Delay  (180) = 4.380
...
%  EP = 95.4 %
  ...
  n49 = bitcmp(bitand(n46, bitand(n14, n0)));
  n50 = bitcmp(bitand(n39, n4));
  n54 = bitcmp(bitand(bitor(n50, n16), n22));
  n67 = bitor(bitand(n41, n20), bitand(bitcmp(n41), n47));
  n71 = bitcmp(n6);
  n74 = bitcmp(n49);
  n77 = bitcmp(bitand(n10, n74));
  n82 = bitand(n6, n20);
  n93 = bitcmp(bitor(n10, n54));
  n94 = bitcmp(bitor(bitand(n77, n67), n18));
  n102 = bitcmp(bitand(bitor(n71, n50), n35));
  n103 = bitcmp(bitand(bitor(n71, n50), n35));
