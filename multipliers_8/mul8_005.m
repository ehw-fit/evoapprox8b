...
%  EP = 99.1 %
  ...
  n65 = n41;
  n67 = n65;
  n68 = bitcmp(bitor(n65, n4));
  n69 = bitcmp(bitor(n65, n4));
  n74 = bitcmp(n65);
  n78 = bitcmp(bitand(bitor(n69, n74), n65));
  ...
  n1678 = n1483;
  n1706 = bitor(bitand(n1321, n68), bitand(bitcmp(n1321), n921));
  n1712 = n921;
  n1720 = bitor(bitand(n1307, n78), bitand(bitcmp(n1307), n1425));
