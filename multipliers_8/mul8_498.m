...
function [ c ] = mul8_498( a, b )
% Approximate function mul8_498
%  Library = EvoApprox8b
%  Circuit = mul8_498
%  Area   (180) = 8912
%  Delay  (180) = 3.490
...
%  EP = 84.5 %
  ...
  n994 = bitor(bitand(n268, n164), bitand(bitcmp(n268), n60));
  n995 = bitor(bitand(n268, n164), bitand(bitcmp(n268), n60));
  ...
  n1290 = bitor(bitand(n1128, n1025), bitand(bitcmp(n1128), n1038));
  n1291 = bitor(bitand(n1128, n1025), bitand(bitcmp(n1128), n1038));
