...
%  EP = 99.0 %
  ...
  n950 = bitand(n12, n30);
  n964 = bitand(n14, n30);
  n1034 = bitcmp(bitor(bitand(n2, n920), n41));
  n1107 = n491;
  ...
  n1780 = bitxor(bitxor(n1633, n1603), n1425);
  n1781 = bitor(bitor(bitand(n1633, n1603), bitand(n1603, n1425)), bitand(n1633, n1425));
