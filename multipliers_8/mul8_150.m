...
function [ c ] = mul8_150( a, b )
% Approximate function mul8_150
%  Library = EvoApprox8b
%  Circuit = mul8_150
%  Area   (180) = 6517
%  Delay  (180) = 4.700
...
%  EP = 95.6 %
  ...
  n41 = bitand(n18, n38);
  n47 = bitcmp(bitand(bitor(n6, n16), n41));
  n50 = bitcmp(bitand(n39, n28));
  ...
  n94 = bitcmp(bitor(bitand(n77, n67), n18));
