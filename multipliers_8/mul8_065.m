...
function [ c ] = mul8_065( a, b )
% Approximate function mul8_065
%  Library = EvoApprox8b
%  Circuit = mul8_065
%  Area   (180) = 12048
%  Delay  (180) = 3.170
...
%  EP = 95.8 %
  ...
  n420 = bitand(n12, n30);
  n426 = bitand(n14, n30);
  n432 = bitxor(n38, n262);
  n433 = bitand(n38, n262);
  n438 = bitcmp(bitand(n44, n88));
  n439 = bitcmp(bitand(n44, n88));
  ...
  n564 = bitxor(bitxor(n101, n453), n494);
  n565 = bitor(bitor(bitand(n101, n453), bitand(n453, n494)), bitand(n101, n494));
  ...
  n652 = bitxor(n345, n547);
  n653 = bitand(n345, n547);
  ...
  n670 = bitxor(bitxor(n453, n565), n596);
  n671 = bitor(bitor(bitand(n453, n565), bitand(n565, n596)), bitand(n453, n596));
  ...
  n916 = bitand(n409, n282);
  n922 = bitor(n809, n916);
  n946 = bitand(n814, n916);
  n952 = bitand(n409, n809);
  ...
  c = bitor(c, bitshift(bitand(n195, 1), 2));
