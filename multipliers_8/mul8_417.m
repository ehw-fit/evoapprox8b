...
function [ c ] = mul8_417( a, b )
% Approximate function mul8_417
%  Library = EvoApprox8b
%  Circuit = mul8_417
%  Area   (180) = 6251
%  Delay  (180) = 3.670
...
%  EP = 97.2 %
  ...
  n34 = bitcmp(bitand(bitor(n10, n16), n18));
  n38 = bitcmp(bitor(n18, n34));
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(n18, n0));
  n49 = bitcmp(n46);
  n69 = bitcmp(n41);
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  ...
  n148 = bitand(n14, n16);
  n149 = bitand(n14, n16);
  n177 = bitcmp(bitand(n18, bitand(n12, n6)));
  n221 = bitand(n49, n102);
  n232 = bitand(n8, n18);
  n249 = bitand(n10, n18);
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n309 = bitcmp(n177);
  n364 = bitand(n149, n232);
  n398 = bitxor(n148, n264);
  n414 = bitxor(n103, n282);
  n415 = bitand(n103, n282);
  n514 = bitand(n10, n20);
  n532 = bitand(n105, n20);
  n548 = bitand(n14, n20);
  n614 = bitor(n364, n82);
  ...
  c = bitor(c, bitshift(bitand(n1382, 1), 1));
  c = bitor(c, bitshift(bitand(n83, 1), 2));
  c = bitor(c, bitshift(bitand(n1232, 1), 3));
