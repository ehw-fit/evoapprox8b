...
function [ c ] = mul8_129( a, b )
% Approximate function mul8_129
%  Library = EvoApprox8b
%  Circuit = mul8_129
%  Area   (180) = 6069
%  Delay  (180) = 4.170
...
%  EP = 97.8 %
  ...
  n33 = bitand(n18, n12);
  n34 = bitcmp(bitand(n33, bitand(n16, n6)));
  n37 = bitcmp(bitor(n26, n34));
  n38 = bitcmp(bitor(n6, bitor(n34, n26)));
  n39 = bitcmp(bitor(n6, bitor(n34, n26)));
  n41 = bitand(n2, n28);
  n42 = n41;
  n44 = bitcmp(bitand(n42, bitand(n4, n14)));
  n45 = bitcmp(bitand(n42, bitand(n4, n14)));
  n46 = bitcmp(bitor(n38, n12));
  n48 = bitcmp(bitand(n41, n38));
  n49 = bitcmp(bitand(n41, n38));
  n51 = bitor(bitand(n2, n28), bitand(bitcmp(n2), n2));
  n54 = bitcmp(n49);
  n55 = bitcmp(n49);
  n57 = bitcmp(n33);
  n60 = n28;
  n63 = bitcmp(bitand(n54, n12));
  n65 = bitcmp(bitor(n18, n12));
  n69 = bitcmp(bitand(n37, n63));
  n73 = bitcmp(bitand(bitor(n2, n46), n51));
  n75 = bitand(n57, n60);
  n78 = bitor(bitand(n45, n44), bitand(bitcmp(n45), n55));
  n82 = bitand(n18, n37);
  n83 = bitand(n18, n37);
  n86 = bitcmp(bitand(n55, n0));
  n87 = bitcmp(bitand(n55, n0));
  n93 = bitand(n69, n82);
  n103 = bitcmp(bitor(n63, bitor(n82, n30)));
  n104 = bitcmp(bitor(n65, n86));
  n105 = bitcmp(bitor(n65, n86));
  n108 = bitor(bitand(n87, n78), bitand(bitcmp(n87), n93));
  n110 = bitcmp(n49);
  n117 = bitcmp(n73);
  n118 = n65;
  n121 = bitor(bitand(n51, n38), bitand(bitcmp(n51), n57));
  n123 = bitcmp(n121);
  n139 = bitcmp(bitand(bitor(n39, n48), n83));
  n142 = bitand(n139, n108);
  n157 = bitor(n65, n4);
  n160 = bitcmp(n110);
  n173 = bitcmp(bitand(n157, n110));
  n175 = bitcmp(bitor(n117, bitor(n160, n173)));
  n193 = bitcmp(n142);
  n206 = bitcmp(bitand(bitor(n10, n104), n75));
  n256 = bitand(n105, n118);
  n282 = bitor(bitand(n14, n18), bitand(bitcmp(n14), n39));
  n361 = bitand(n193, n206);
  n398 = bitand(n45, n256);
