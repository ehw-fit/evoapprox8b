...
function [ c ] = mul8_416( a, b )
% Approximate function mul8_416
%  Library = EvoApprox8b
%  Circuit = mul8_416
%  Area   (180) = 5932
%  Delay  (180) = 4.680
...
%  EP = 97.8 %
  ...
  n34 = bitcmp(bitand(n30, bitand(n28, n26)));
  n37 = bitcmp(bitor(bitand(n2, n28), n30));
  n39 = bitor(bitand(n26, n20), bitand(bitcmp(n26), n22));
  n40 = bitxor(n2, n39);
  n41 = bitand(n2, n39);
  n43 = bitcmp(bitor(n33, n34));
  n46 = n43;
  n47 = n43;
  n49 = bitcmp(bitand(n46, n14));
  n54 = bitcmp(bitor(n33, n24));
  n57 = n49;
  n58 = bitcmp(bitor(n37, bitor(n40, n14)));
  n66 = bitcmp(bitand(n18, n16));
  n69 = bitcmp(bitor(n58, n66));
  n73 = bitcmp(bitor(n49, n47));
  n83 = bitand(n39, n4);
  n131 = n69;
  n193 = bitcmp(bitand(n57, bitand(n12, n131)));
  n201 = bitcmp(n193);
  n224 = n73;
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
