...
function [ c ] = mul8_442( a, b )
% Approximate function mul8_442
%  Library = EvoApprox8b
%  Circuit = mul8_442
%  Area   (180) = 9951
%  Delay  (180) = 3.050
...
%  EP = 86.7 %
  ...
  n32 = bitand(n18, n16);
  n33 = bitand(n18, n16);
  n35 = bitcmp(bitand(n10, n12));
  n37 = bitcmp(bitor(n28, bitor(n12, n35)));
  n38 = bitxor(bitxor(n37, n0), n14);
  n41 = bitcmp(bitand(n33, n14));
  n46 = bitand(n2, n16);
  n54 = bitcmp(bitor(n26, n46));
  n57 = bitcmp(bitor(n41, bitor(n38, n6)));
  n60 = bitand(n4, n16);
  n61 = bitand(n4, n16);
  n62 = bitcmp(bitand(bitor(n57, n20), n61));
  n65 = bitcmp(bitor(n18, n12));
  n67 = bitcmp(bitor(n8, bitor(n4, n41)));
  n76 = bitand(n6, n16);
  n77 = bitand(n6, n16);
  n80 = bitcmp(bitor(n18, n12));
  n86 = bitcmp(bitxor(n6, n80));
  n90 = bitand(n8, n16);
  n92 = bitcmp(bitand(n57, n62));
  n97 = bitcmp(bitor(n57, bitor(n86, n67)));
  n98 = bitcmp(bitor(bitand(n65, n92), n97));
  n106 = bitand(n10, n16);
  n121 = bitand(n12, n16);
  n134 = bitand(n14, n16);
  n150 = bitand(n0, n18);
  n153 = bitor(n33, n134);
  n180 = bitand(n77, n98);
  n190 = bitcmp(bitxor(n26, n32));
  n194 = bitand(n6, n18);
  n198 = bitand(n153, n38);
  n206 = bitor(n10, n54);
  n208 = bitand(n8, n18);
  n224 = bitand(n10, n18);
  n233 = bitcmp(bitor(n121, bitor(n198, n22)));
  n238 = bitand(n12, n18);
  n254 = bitand(n14, n18);
  n268 = bitand(n0, n206);
  n283 = bitand(n2, n190);
  ...
  n417 = bitand(n4, n22);
  n432 = bitand(n6, n22);
  n441 = bitand(n18, n342);
  n446 = bitand(n8, n22);
  n460 = bitand(n10, n22);
  n476 = bitand(n12, n22);
  n491 = bitand(n14, n22);
  n506 = bitand(n0, n24);
  n518 = bitcmp(bitor(bitand(n233, n32), n441));
  n520 = bitand(n2, n24);
  n534 = bitand(n4, n24);
  n545 = bitand(n313, n518);
  n550 = bitand(n6, n24);
  n564 = bitand(n8, n24);
  n580 = bitand(n10, n24);
  n594 = bitand(n12, n24);
  ...
  n994 = bitxor(bitxor(n60, n534), n268);
  n995 = bitor(bitor(bitand(n60, n534), bitand(n534, n268)), bitand(n60, n268));
  n1008 = bitxor(n76, n180);
  n1009 = bitxor(n76, n180);
  n1024 = bitand(n90, n194);
  ...
  c = bitor(c, bitshift(bitand(n1184, 1), 3));
