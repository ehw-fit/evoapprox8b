...
function [ c ] = mul8_430( a, b )
% Approximate function mul8_430
%  Library = EvoApprox8b
%  Circuit = mul8_430
%  Area   (180) = 5337
%  Delay  (180) = 2.300
...
%  EP = 99.1 %
  ...
  n71 = bitcmp(n69);
  n73 = bitand(n65, n46);
  n76 = bitcmp(bitand(bitor(n57, n70), n51));
  ...
  n137 = bitor(bitand(n51, n119), bitand(bitcmp(n51), n121));
