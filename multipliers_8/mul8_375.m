...
function [ c ] = mul8_375( a, b )
% Approximate function mul8_375
%  Library = EvoApprox8b
%  Circuit = mul8_375
%  Area   (180) = 9136
%  Delay  (180) = 3.480
...
%  EP = 43.8 %
  ...
  n1156 = bitxor(bitxor(n446, n550), n655);
  n1157 = bitor(bitor(bitand(n446, n550), bitand(n550, n655)), bitand(n446, n655));
