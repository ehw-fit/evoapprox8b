...
function [ c ] = mul8_462( a, b )
% Approximate function mul8_462
%  Library = EvoApprox8b
%  Circuit = mul8_462
%  Area   (180) = 6649
%  Delay  (180) = 4.590
...
%  EP = 94.9 %
  ...
  n32 = bitcmp(bitor(n28, bitor(n14, n6)));
  n34 = bitcmp(bitand(bitor(n6, n32), n14));
  n35 = bitcmp(bitand(bitor(n6, n32), n14));
  ...
  n67 = bitor(n35, n12);
  n69 = bitcmp(n41);
  n74 = bitcmp(bitand(n22, bitand(n24, n18)));
  n77 = bitcmp(bitand(n10, n74));
  n82 = bitand(n6, n20);
  n94 = bitcmp(bitor(bitand(n77, n67), n65));
  n102 = bitcmp(bitand(bitor(n26, n50), n51));
  n103 = bitcmp(bitand(bitor(n26, n50), n51));
  n105 = bitcmp(n65);
  n114 = bitand(n103, n16);
  n115 = bitand(n103, n16);
  n132 = bitand(n94, n16);
  n148 = bitand(n14, n16);
  n221 = n49;
  n232 = bitand(n8, n18);
  ...
  n882 = bitxor(bitxor(n632, n748), n815);
  n883 = bitor(bitor(bitand(n632, n748), bitand(n748, n815)), bitand(n632, n815));
  ...
  n1099 = bitand(n365, n356);
  n1114 = bitxor(bitxor(n864, n982), n1099);
  n1132 = bitor(n882, n998);
  ...
  c = bitor(c, bitshift(bitand(n982, 1), 1));
