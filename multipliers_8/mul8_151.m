...
%  EP = 99.1 %
  ...
  n32 = bitand(n18, n12);
  n35 = bitor(bitor(bitand(n14, n16), bitand(n16, n30)), bitand(n14, n30));
  n41 = bitcmp(bitxor(n12, n12));
  n42 = bitcmp(bitand(n6, n28));
  n49 = bitcmp(bitor(bitand(n18, n14), n32));
  n51 = bitor(bitor(bitand(n41, n4), bitand(n4, n2)), bitand(n41, n2));
  ...
  n1678 = n1483;
  n1706 = bitxor(bitxor(n921, n68), n665);
  n1712 = n921;
