...
function [ c ] = mul8_000( a, b )
% Approximate function mul8_000
%  Library = EvoApprox8b
%  Circuit = mul8_000
%  Area   (180) = 9224
%  Delay  (180) = 3.130
...
%  EP = 86.5 %
  ...
  n1898 = bitxor(bitxor(n1734, n1721), n1211);
  n1899 = bitor(bitor(bitand(n1734, n1721), bitand(n1721, n1211)), bitand(n1734, n1211));
