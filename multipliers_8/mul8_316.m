...
function [ c ] = mul8_316( a, b )
% Approximate function mul8_316
%  Library = EvoApprox8b
%  Circuit = mul8_316
%  Area   (180) = 8716
%  Delay  (180) = 5.340
...
%  EP = 45.8 %
  ...
  n32 = bitand(n0, n16);
  n33 = bitand(n0, n16);
  n34 = bitcmp(bitor(n22, bitor(n24, n30)));
  n35 = bitcmp(bitor(n22, bitor(n24, n30)));
  n36 = bitcmp(bitand(n20, bitand(n22, n30)));
  n38 = bitcmp(bitor(n18, bitor(n28, n22)));
  n42 = bitand(n14, n32);
  n49 = bitand(n2, n16);
  n54 = bitcmp(bitor(bitand(n30, n42), n36));
  n57 = bitcmp(bitor(bitand(n18, n38), n35));
  n59 = bitand(n18, n34);
  n61 = bitcmp(bitand(n33, bitand(n6, n59)));
  n65 = bitand(n4, n54);
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n16);
