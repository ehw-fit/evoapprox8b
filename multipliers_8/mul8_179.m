...
function [ c ] = mul8_179( a, b )
% Approximate function mul8_179
%  Library = EvoApprox8b
%  Circuit = mul8_179
%  Area   (180) = 6725
%  Delay  (180) = 5.800
...
%  EP = 96.0 %
  ...
  n38 = bitcmp(bitor(n10, bitor(n34, n14)));
  n39 = bitcmp(bitor(n10, bitor(n34, n14)));
  n41 = bitand(n18, n38);
  ...
  n121 = bitxor(n41, n12);
  n132 = bitand(n121, n16);
  n148 = bitand(n14, n16);
  n193 = n57;
  n221 = bitor(bitor(bitand(n49, n102), bitand(n102, n14)), bitand(n49, n14));
  n232 = bitand(n2, n18);
  n248 = bitand(n10, n18);
  n264 = bitand(n12, n18);
  n265 = bitand(n12, n18);
  ...
  c = bitor(c, bitshift(bitand(n265, 1), 0));
