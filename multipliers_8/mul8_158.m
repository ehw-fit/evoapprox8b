...
function [ c ] = mul8_158( a, b )
% Approximate function mul8_158
%  Library = EvoApprox8b
%  Circuit = mul8_158
%  Area   (180) = 6587
%  Delay  (180) = 2.970
...
%  EP = 98.4 %
  ...
  n46 = bitand(n2, n16);
  n49 = bitxor(n18, n12);
  n50 = bitor(bitand(n18, n0), bitand(bitcmp(n18), n26));
  n53 = bitand(n41, n42);
  n54 = bitcmp(bitand(n49, n33));
  n57 = bitcmp(bitor(n33, n28));
  n65 = bitcmp(bitor(n57, n54));
  n70 = bitcmp(bitor(n4, n42));
  n73 = bitcmp(bitor(n33, n54));
  n78 = bitcmp(bitand(n35, n32));
  n82 = bitcmp(n53);
  n93 = bitcmp(bitand(n57, n78));
  n94 = bitxor(n41, n82);
  n100 = bitxor(n93, n38);
  n105 = bitor(n70, n12);
  n121 = bitand(n18, n70);
  n131 = bitcmp(bitand(n41, n100));
  n134 = bitand(n14, n16);
  n137 = bitand(n73, n38);
  ...
  n1247 = bitand(n233, n981);
  n1306 = bitand(n1247, n256);
  n1307 = bitand(n1247, n256);
