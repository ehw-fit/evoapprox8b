...
function [ c ] = mul8_034( a, b )
% Approximate function mul8_034
%  Library = EvoApprox8b
%  Circuit = mul8_034
%  Area   (180) = 10770
%  Delay  (180) = 2.400
...
%  EP = 93.6 %
  ...
  n37 = bitxor(n26, n34);
  n38 = bitor(bitand(n24, n8), bitand(bitcmp(n24), n22));
  n39 = bitor(bitand(n24, n8), bitand(bitcmp(n24), n22));
  n40 = bitxor(n18, n28);
  n41 = bitxor(n18, n28);
  n43 = bitand(n2, n8);
  n46 = bitand(n2, n16);
  ...
  n65 = bitand(n18, n12);
  n67 = bitcmp(n37);
  n70 = bitcmp(bitand(n41, bitand(n28, n43)));
  n71 = bitcmp(bitand(n41, bitand(n28, n43)));
  n72 = bitcmp(bitor(bitand(n65, n46), n51));
  n73 = bitcmp(bitor(bitand(n65, n46), n51));
  n74 = bitcmp(bitand(bitor(n67, n24), n53));
  n76 = bitand(n6, n16);
  n77 = bitand(n6, n16);
  ...
  n113 = bitcmp(bitor(bitand(n105, n70), n83));
  n121 = bitand(n12, n16);
  n126 = bitor(bitand(n95, n100), bitand(bitcmp(n95), n33));
  n134 = bitand(n14, n16);
  n145 = bitcmp(n41);
  n150 = bitand(n105, n18);
  n164 = bitand(n2, n18);
  n166 = bitcmp(bitand(n113, bitand(n40, n30)));
  n167 = bitcmp(bitand(n113, bitand(n40, n30)));
  n169 = bitcmp(bitxor(n18, n86));
  n180 = bitand(n4, n46);
  n185 = bitcmp(bitor(n2, n28));
  n194 = bitand(n145, n18);
  n208 = bitand(n8, n18);
  n224 = bitand(n10, n18);
  n233 = bitcmp(n73);
  n238 = bitand(n12, n18);
  ...
  n432 = bitand(n6, n22);
  n446 = bitand(n8, n22);
  n449 = bitcmp(bitor(n185, bitor(n166, n243)));
  n456 = n105;
  n460 = bitand(n10, n22);
  n476 = bitand(n12, n22);
  n490 = bitand(n14, n22);
  ...
  n682 = bitand(n8, n26);
  n698 = bitand(n10, n26);
  n701 = bitand(n121, n362);
  n712 = bitand(n12, n26);
  n728 = bitand(n14, n26);
  n739 = bitcmp(bitxor(n251, n356));
  n742 = bitand(n0, n28);
  n756 = bitand(n2, n28);
  n772 = bitand(n4, n28);
  n786 = bitand(n6, n28);
  ...
  n989 = bitor(n265, n342);
  n994 = bitxor(n60, n164);
  n995 = bitxor(n60, n164);
  ...
  c = bitor(c, bitshift(bitand(n989, 1), 4));
