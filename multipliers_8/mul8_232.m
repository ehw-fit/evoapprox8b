...
function [ c ] = mul8_232( a, b )
% Approximate function mul8_232
%  Library = EvoApprox8b
%  Circuit = mul8_232
%  Area   (180) = 7348
%  Delay  (180) = 3.320
...
%  EP = 97.3 %
  ...
  n32 = bitand(n18, n12);
  n33 = bitand(n18, n12);
  n34 = bitcmp(bitand(n18, bitand(n12, n2)));
  n35 = bitcmp(bitand(n18, bitand(n12, n2)));
  ...
  n1734 = bitxor(bitxor(n1572, n1557), n43);
  n1735 = bitor(bitor(bitand(n1572, n1557), bitand(n1557, n43)), bitand(n1572, n43));
  ...
  n1869 = bitor(bitor(bitand(n1706, n1691), bitand(n1691, n35)), bitand(n1706, n35));
