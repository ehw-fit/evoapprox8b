...
function [ c ] = mul8_094( a, b )
% Approximate function mul8_094
%  Library = EvoApprox8b
%  Circuit = mul8_094
%  Area   (180) = 6777
%  Delay  (180) = 4.500
...
%  EP = 93.5 %
  ...
  n38 = bitcmp(bitor(n26, bitor(n34, n22)));
  n39 = bitcmp(bitor(n26, bitor(n34, n22)));
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(bitor(n22, n16), n2));
  n49 = bitcmp(n46);
  n50 = bitcmp(n39);
  n57 = bitor(bitand(n22, n38), bitand(bitcmp(n22), n41));
  n69 = bitcmp(n41);
  n81 = n57;
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  ...
  n114 = bitand(n103, n0);
  n121 = bitcmp(bitand(n81, bitand(n46, n83)));
  n132 = bitand(n12, n16);
  n148 = bitand(n14, n16);
