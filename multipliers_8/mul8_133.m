...
function [ c ] = mul8_133( a, b )
% Approximate function mul8_133
%  Library = EvoApprox8b
%  Circuit = mul8_133
%  Area   (180) = 6728
%  Delay  (180) = 3.720
...
%  EP = 97.7 %
  ...
  n35 = bitor(n8, n24);
  n37 = bitcmp(bitor(n18, bitor(n28, n6)));
  n38 = bitcmp(bitor(n18, bitor(n28, n10)));
  n39 = bitcmp(bitor(n18, bitor(n28, n10)));
  n41 = bitand(n2, n30);
  n43 = n6;
  n46 = bitcmp(bitxor(n41, n0));
  n49 = bitcmp(bitand(n18, bitand(n12, n0)));
  n54 = bitcmp(bitor(n35, n28));
  n57 = bitand(n2, n12);
  n62 = bitand(n57, n38);
  n63 = bitand(n57, n38);
  n66 = bitcmp(bitand(n43, n8));
  n67 = bitcmp(bitand(n43, n8));
  n71 = bitcmp(bitand(n35, n8));
  n73 = n33;
  ...
  n86 = bitor(n71, n46);
  n93 = n49;
  n97 = bitcmp(bitand(n18, n12));
  n126 = bitcmp(bitand(n93, n74));
  n133 = bitcmp(bitand(n77, bitand(n62, n39)));
  n134 = n2;
  n148 = bitand(n14, n16);
  n197 = n97;
  n206 = bitor(n133, n66);
  n217 = bitcmp(bitor(n86, bitor(n134, n67)));
  n257 = bitand(n18, n12);
  n264 = bitand(n12, n18);
  n275 = bitcmp(n197);
  n282 = bitand(n14, n18);
  ...
  n405 = n93;
  n414 = bitxor(n275, n282);
  n415 = bitand(n275, n282);
  ...
  n932 = bitxor(bitxor(n682, n798), n899);
  n933 = bitor(bitor(bitand(n682, n798), bitand(n798, n899)), bitand(n682, n899));
