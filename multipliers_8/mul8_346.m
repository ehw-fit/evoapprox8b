...
function [ c ] = mul8_346( a, b )
% Approximate function mul8_346
%  Library = EvoApprox8b
%  Circuit = mul8_346
%  Area   (180) = 8312
%  Delay  (180) = 5.470
...
%  EP = 69.2 %
  ...
  n38 = bitor(bitand(n22, n28), bitand(bitcmp(n22), n18));
  n40 = bitcmp(bitand(n38, n28));
  n54 = bitcmp(bitor(bitand(n30, n40), n6));
  n61 = bitcmp(bitand(n37, bitand(n6, n22)));
  n65 = bitand(n4, n54);
  n82 = bitand(n6, n16);
  n86 = bitcmp(bitor(n61, n54));
  n89 = n86;
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
