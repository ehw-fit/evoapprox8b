...
function [ c ] = mul8_134( a, b )
% Approximate function mul8_134
%  Library = EvoApprox8b
%  Circuit = mul8_134
%  Area   (180) = 6608
%  Delay  (180) = 5.590
...
%  EP = 93.9 %
  ...
  n38 = bitcmp(bitor(n22, bitor(n34, n14)));
  n39 = bitcmp(bitor(n22, bitor(n34, n14)));
  n41 = bitand(n12, n38);
  n46 = bitcmp(bitand(bitor(n14, n8), n41));
  n48 = bitcmp(bitor(n46, bitor(n12, n0)));
  n49 = bitcmp(bitor(n46, bitor(n12, n0)));
  n50 = bitcmp(bitand(bitor(n39, n16), n39));
  n53 = bitcmp(bitor(bitand(n18, n50), n14));
  n65 = bitor(n41, n39);
  n69 = bitcmp(n2);
  n77 = bitcmp(n10);
  n82 = bitand(n6, n48);
