...
function [ c ] = mul8_035( a, b )
% Approximate function mul8_035
%  Library = EvoApprox8b
%  Circuit = mul8_035
%  Area   (180) = 9175
%  Delay  (180) = 2.980
...
%  EP = 73.2 %
  ...
  n1276 = bitor(bitand(n1112, n1009), bitand(bitcmp(n1112), n1024));
  n1277 = bitor(bitand(n1112, n1009), bitand(bitcmp(n1112), n1024));
