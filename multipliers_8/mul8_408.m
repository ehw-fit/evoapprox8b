...
function [ c ] = mul8_408( a, b )
% Approximate function mul8_408
%  Library = EvoApprox8b
%  Circuit = mul8_408
%  Area   (180) = 5401
%  Delay  (180) = 2.300
...
%  EP = 99.1 %
  ...
  n70 = bitcmp(n69);
  n71 = bitcmp(n69);
  n73 = bitcmp(bitor(n65, n46));
  n76 = bitcmp(bitand(bitor(n57, n4), n51));
  ...
  n132 = bitcmp(bitor(bitand(n26, n70), n71));
  n134 = bitor(n37, n132);
  n137 = bitor(bitand(n51, n119), bitand(bitcmp(n51), n2));
