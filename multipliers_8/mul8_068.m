...
function [ c ] = mul8_068( a, b )
% Approximate function mul8_068
%  Library = EvoApprox8b
%  Circuit = mul8_068
%  Area   (180) = 6701
%  Delay  (180) = 5.740
...
%  EP = 96.0 %
  ...
  n50 = bitcmp(n39);
  n51 = bitcmp(n39);
  n55 = bitor(bitand(n22, n16), bitand(bitcmp(n22), n4));
  n57 = bitcmp(bitand(n41, n28));
  ...
  n94 = bitcmp(bitor(bitand(n10, n70), n67));
  ...
  n221 = bitand(n49, n182);
  n227 = bitcmp(bitand(n77, n34));
  n233 = bitand(n2, n18);
  n248 = bitand(n10, n18);
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n364 = bitcmp(bitand(n114, n46));
  n365 = bitcmp(bitand(n114, n46));
  n372 = bitor(n69, n46);
