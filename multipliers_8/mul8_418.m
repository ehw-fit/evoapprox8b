...
function [ c ] = mul8_418( a, b )
% Approximate function mul8_418
%  Library = EvoApprox8b
%  Circuit = mul8_418
%  Area   (180) = 8728
%  Delay  (180) = 3.370
...
%  EP = 94.1 %
  ...
  n1290 = bitxor(bitxor(n85, n1025), n1128);
  n1291 = bitor(bitor(bitand(n85, n1025), bitand(n1025, n1128)), bitand(n85, n1128));
  n1306 = n1054;
  n1307 = n1054;
  ...
  n1528 = bitor(n1290, n1277);
  n1529 = bitor(n1290, n1277);
  ...
  n1676 = bitxor(n1512, n1142);
  n1677 = bitand(n1512, n1142);
  ...
  c = bitor(c, bitshift(bitand(n432, 1), 3));
