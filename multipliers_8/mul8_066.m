...
function [ c ] = mul8_066( a, b )
% Approximate function mul8_066
%  Library = EvoApprox8b
%  Circuit = mul8_066
%  Area   (180) = 6292
%  Delay  (180) = 2.320
...
%  EP = 98.7 %
  ...
  n38 = bitcmp(bitor(n18, n36));
  n41 = bitcmp(bitxor(n12, n12));
  n45 = bitcmp(bitor(n37, n28));
  ...
  n63 = n41;
  n65 = bitcmp(n57);
  n70 = bitcmp(bitor(n10, n63));
  n77 = bitcmp(bitand(n37, n38));
  n81 = bitand(n57, n38);
  n86 = n63;
  n88 = bitor(bitand(n51, n86), bitand(bitcmp(n51), n81));
  n89 = bitor(bitand(n51, n86), bitand(bitcmp(n51), n81));
  n92 = bitcmp(bitor(n89, n62));
  n93 = bitcmp(bitor(n89, n62));
  n97 = bitcmp(n41);
  n102 = bitcmp(bitor(n81, bitor(n88, n51)));
  n103 = bitcmp(bitor(n81, bitor(n88, n51)));
  n106 = bitcmp(n63);
  n110 = bitcmp(bitand(n26, n0));
  n122 = bitcmp(bitor(n93, n92));
  n123 = bitcmp(bitor(n93, n92));
  n129 = bitor(bitand(n6, n102), bitand(bitcmp(n6), n110));
  n134 = bitand(n61, n106);
  n153 = n129;
  n163 = bitand(n45, n88);
  n169 = bitcmp(n49);
  n198 = bitcmp(bitand(n93, n0));
  n222 = bitcmp(bitor(n103, n122));
  n233 = bitcmp(bitand(n65, bitand(n134, n22)));
  n238 = n163;
  n244 = bitcmp(n61);
  n253 = bitcmp(bitor(n97, n122));
  n254 = bitand(n14, n18);
  n274 = bitcmp(bitand(n129, n134));
  n297 = bitor(n169, n222);
  n313 = bitcmp(n233);
  n323 = n77;
  n352 = n313;
  n356 = bitand(n12, n20);
  ...
  n372 = bitand(n14, n20);
  n374 = n97;
  n396 = bitxor(n93, n198);
  n411 = bitcmp(bitor(n253, bitor(n396, n371)));
  ...
  n1854 = bitor(n1690, n244);
  n1868 = bitxor(n253, n1691);
  n1882 = bitor(bitand(n411, n274), bitand(bitcmp(n411), n1720));
  n1898 = n1734;
