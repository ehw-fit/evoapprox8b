...
function [ c ] = mul8_362( a, b )
% Approximate function mul8_362
%  Library = EvoApprox8b
%  Circuit = mul8_362
%  Area   (180) = 7512
%  Delay  (180) = 6.150
...
%  EP = 88.0 %
  ...
  n39 = bitor(n33, n0);
  n41 = n33;
  n75 = bitcmp(bitor(n6, bitor(n24, n26)));
  n82 = bitand(n6, n20);
  ...
  n798 = bitand(n12, n22);
  n814 = bitand(n14, n22);
  n832 = bitand(n777, n698);
  n848 = bitxor(bitxor(n665, n714), n227);
  n849 = bitor(bitor(bitand(n665, n714), bitand(n714, n227)), bitand(n665, n227));
