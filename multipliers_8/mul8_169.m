...
function [ c ] = mul8_169( a, b )
% Approximate function mul8_169
%  Library = EvoApprox8b
%  Circuit = mul8_169
%  Area   (180) = 6917
%  Delay  (180) = 5.070
...
%  EP = 95.8 %
  ...
  n34 = bitcmp(bitand(n22, bitand(n32, n14)));
  n35 = bitcmp(bitand(n22, bitand(n32, n14)));
  ...
  n48 = bitcmp(bitor(n46, bitor(n12, n6)));
  n49 = bitcmp(bitor(n46, bitor(n12, n6)));
  n50 = bitcmp(n39);
  n54 = bitcmp(n50);
  n56 = bitcmp(bitand(n49, n46));
  n57 = bitcmp(bitand(n49, n46));
  n67 = bitcmp(bitand(n47, n48));
  n69 = bitcmp(n41);
  n78 = bitcmp(bitor(n30, n56));
  n82 = bitcmp(bitand(n6, bitand(n20, n18)));
  n83 = bitcmp(bitand(n6, bitand(n20, n18)));
  n90 = n49;
  n92 = bitcmp(bitor(n10, n46));
  n93 = bitcmp(bitor(n10, n46));
  n94 = bitcmp(bitand(bitor(n10, n67), n35));
  n95 = bitcmp(bitand(bitor(n10, n67), n35));
  n97 = bitcmp(bitxor(n78, n54));
  n102 = bitcmp(bitand(bitor(n26, n50), n35));
  n103 = bitcmp(bitand(bitor(n26, n50), n35));
  n114 = bitand(n103, n92);
  n115 = bitand(n103, n92);
  n132 = bitcmp(bitor(bitand(n94, n16), n83));
  n134 = bitor(n69, n114);
  n148 = bitand(n14, n16);
  n182 = bitand(n93, n8);
  n193 = bitcmp(bitor(n57, n134));
  n210 = bitand(n95, n46);
  n221 = bitor(bitor(bitand(n49, n182), bitand(n182, n14)), bitand(n49, n14));
  n248 = bitand(n10, n18);
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  n364 = bitcmp(bitand(n114, n210));
  n365 = bitcmp(bitand(n114, n210));
  n372 = n69;
  ...
  n1059 = bitor(n795, n372);
  n1064 = bitand(n12, n24);
  n1082 = bitand(n14, n24);
  n1099 = bitand(n365, n964);
  n1114 = bitxor(bitxor(n864, n798), n1099);
  n1132 = bitor(bitand(n1059, n998), bitand(bitcmp(n1059), n193));
