...
%  EP = 97.8 %
  ...
  n37 = bitcmp(bitor(n33, n34));
  n38 = bitcmp(bitor(n4, bitor(n34, n22)));
  n39 = bitcmp(bitor(n4, bitor(n34, n22)));
  n49 = bitcmp(bitand(n18, n38));
  n51 = bitcmp(n39);
  n54 = bitcmp(n49);
  n55 = bitcmp(n49);
  n57 = bitcmp(bitor(bitand(n38, n54), n51));
  n60 = bitcmp(bitand(n18, bitand(n4, n55)));
  n63 = bitcmp(bitand(n55, n24));
  n73 = bitcmp(bitand(n33, n28));
  n86 = bitand(n55, n60);
  n89 = bitcmp(n57);
  n99 = bitcmp(bitor(bitand(n63, n54), n49));
  n101 = bitcmp(bitor(n57, n38));
  n123 = bitcmp(n101);
  n146 = bitcmp(n63);
  n160 = bitcmp(bitand(n89, n86));
  n214 = bitcmp(bitor(bitand(n123, n160), n57));
  n282 = bitor(bitand(n14, n18), bitand(bitcmp(n14), n39));
  n393 = bitxor(n214, n38);
  ...
  c = bitor(c, bitshift(bitand(n86, 1), 1));
  c = bitor(c, bitshift(bitand(n99, 1), 2));
