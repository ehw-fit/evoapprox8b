...
function [ c ] = mul8_221( a, b )
% Approximate function mul8_221
%  Library = EvoApprox8b
%  Circuit = mul8_221
%  Area   (180) = 6934
%  Delay  (180) = 3.190
...
%  EP = 98.3 %
  ...
  n42 = bitcmp(bitand(n41, bitand(n16, n14)));
  n46 = bitand(n2, n16);
  n49 = bitxor(n18, n12);
  n50 = bitor(bitand(n18, n20), bitand(bitcmp(n18), n26));
  n54 = bitcmp(bitand(n49, n33));
  n55 = bitcmp(bitand(n49, n33));
  n56 = bitcmp(bitor(n2, n38));
  n57 = bitcmp(bitor(n2, n38));
  n63 = bitor(bitand(n55, n28), bitand(bitcmp(n55), n6));
  n65 = bitcmp(bitor(n57, n55));
  n67 = bitand(n14, n0);
  n70 = bitcmp(bitor(n65, n42));
  n73 = bitcmp(bitor(n33, n54));
  n88 = bitcmp(bitand(n57, bitand(n28, n67)));
  n89 = bitcmp(bitand(n57, bitand(n28, n67)));
  n105 = bitor(n70, n12);
  n107 = bitand(n63, n56);
  n121 = bitand(n18, n70);
