...
%  EP = 98.0 %
  ...
  n89 = n18;
  n97 = bitxor(n78, n87);
  n101 = bitcmp(bitand(bitor(n69, n82), n43));
  n102 = n101;
  n103 = n101;
  n105 = bitcmp(bitand(n97, bitand(n86, n22)));
  n111 = bitcmp(n105);
  n121 = bitor(bitand(n51, n111), bitand(bitcmp(n51), n78));
  n123 = bitcmp(n121);
  n282 = n103;
  n369 = bitcmp(bitand(n89, n102));
  n398 = bitand(n369, n32);
  ...
  c = bitor(c, bitshift(bitand(n1033, 1), 0));
