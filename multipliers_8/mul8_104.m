...
function [ c ] = mul8_104( a, b )
% Approximate function mul8_104
%  Library = EvoApprox8b
%  Circuit = mul8_104
%  Area   (180) = 7139
%  Delay  (180) = 4.840
...
%  EP = 92.8 %
  ...
  n37 = bitcmp(bitand(n26, bitand(n20, n24)));
  n38 = bitcmp(bitor(n18, n32));
  n39 = bitcmp(bitor(n18, n32));
  n41 = bitor(bitor(bitand(n2, n38), bitand(n38, n22)), bitand(n2, n22));
  n49 = bitor(n28, n12);
  n51 = bitcmp(n39);
  n64 = bitcmp(bitor(n28, bitor(n38, n51)));
  n65 = bitcmp(bitor(n28, bitor(n38, n51)));
  n73 = bitcmp(bitand(bitor(n49, n28), n22));
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  ...
  n1114 = bitcmp(bitor(bitand(n137, n982), n1099));
