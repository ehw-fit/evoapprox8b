...
function [ c ] = mul8_029( a, b )
% Approximate function mul8_029
%  Library = EvoApprox8b
%  Circuit = mul8_029
%  Area   (180) = 8408
%  Delay  (180) = 5.500
...
%  EP = 69.5 %
  ...
  n32 = bitand(n0, n16);
  n36 = bitcmp(bitand(n10, bitand(n28, n30)));
  n38 = bitcmp(bitor(n18, bitor(n36, n30)));
  n40 = bitcmp(bitand(n28, n38));
  n41 = bitcmp(bitand(n28, n38));
  n54 = bitcmp(bitor(bitand(n10, n40), n41));
  n65 = bitand(n4, n54);
  n81 = n41;
  n82 = bitand(n6, n16);
  n97 = bitand(n18, n38);
