...
function [ c ] = mul8_274( a, b )
% Approximate function mul8_274
%  Library = EvoApprox8b
%  Circuit = mul8_274
%  Area   (180) = 5579
%  Delay  (180) = 4.180
...
%  EP = 97.9 %
  ...
  n32 = bitand(n18, n12);
  n33 = bitand(n18, n12);
  n34 = bitcmp(bitand(n22, bitand(n16, n6)));
  n36 = bitcmp(bitor(n33, n34));
  ...
  n64 = bitand(n46, n54);
  n65 = bitand(n46, n54);
  n78 = bitcmp(bitand(bitor(n55, n38), n2));
  n79 = bitcmp(bitand(bitor(n55, n38), n2));
  n81 = n41;
  n83 = bitand(n33, n64);
  n113 = bitcmp(bitand(n41, n12));
  n121 = bitor(bitand(n51, n46), bitand(bitcmp(n51), n113));
  n123 = bitcmp(n121);
  n136 = n65;
  n137 = n65;
  n160 = bitcmp(n137);
  n175 = bitcmp(bitor(n22, bitor(n160, n79)));
  n215 = bitcmp(n49);
  n282 = bitor(bitand(n14, n18), bitand(bitcmp(n14), n39));
  n398 = bitand(n215, n32);
  n414 = bitxor(n123, n282);
  n415 = bitand(n123, n282);
  n502 = bitcmp(bitxor(n65, n136));
  n514 = bitand(n10, n20);
  n532 = bitand(n12, n20);
  n548 = bitand(n14, n20);
  ...
  n987 = bitand(n175, n502);
  n1014 = bitand(n6, n24);
  n1032 = bitand(n8, n24);
  n1048 = bitand(n10, n24);
  n1055 = bitcmp(bitor(n815, n78));
  n1064 = bitand(n12, n24);
  n1082 = bitand(n14, n24);
  n1148 = bitxor(bitxor(n898, n1014), n1055);
  n1149 = bitor(bitor(bitand(n898, n1014), bitand(n1014, n1055)), bitand(n898, n1055));
