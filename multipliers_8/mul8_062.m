...
function [ c ] = mul8_062( a, b )
% Approximate function mul8_062
%  Library = EvoApprox8b
%  Circuit = mul8_062
%  Area   (180) = 6489
%  Delay  (180) = 4.830
...
%  EP = 95.1 %
  ...
  n41 = bitand(n18, n38);
  n42 = bitcmp(bitand(n18, bitand(n34, n22)));
  n46 = bitcmp(bitand(bitor(n22, n16), n41));
  n49 = bitcmp(bitor(n46, bitor(n14, n0)));
  n50 = bitcmp(bitand(n39, n4));
  n74 = bitcmp(bitor(n49, n18));
  n77 = bitcmp(bitand(n10, n74));
  n82 = bitand(n6, n20);
  n93 = bitcmp(bitor(n10, n42));
  n94 = bitcmp(bitor(bitand(n77, n32), n18));
