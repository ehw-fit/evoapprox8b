...
function [ c ] = mul8_255( a, b )
% Approximate function mul8_255
%  Library = EvoApprox8b
%  Circuit = mul8_255
%  Area   (180) = 6676
%  Delay  (180) = 3.800
...
%  EP = 96.7 %
  ...
  n33 = bitcmp(bitor(n28, bitor(n12, n6)));
  n34 = bitcmp(bitand(n8, bitand(n24, n10)));
  n37 = bitcmp(bitor(n18, bitor(n28, n30)));
  n38 = bitcmp(bitor(n14, bitor(n34, n10)));
  n39 = bitcmp(bitor(n14, bitor(n34, n10)));
  n41 = bitand(n2, n38);
  n46 = bitcmp(bitxor(n18, n20));
  n48 = bitcmp(bitand(n18, bitand(n12, n0)));
  n49 = bitcmp(bitand(n18, bitand(n12, n0)));
  n54 = bitcmp(bitor(n22, n48));
  n55 = bitcmp(bitor(n22, n48));
  n61 = bitcmp(bitor(n41, n38));
  n62 = bitand(n55, n38);
  n63 = bitand(n55, n38);
  n66 = bitor(bitand(n30, n8), bitand(bitcmp(n30), n48));
  n71 = bitcmp(bitand(n61, n8));
  n73 = n33;
  n74 = bitcmp(bitand(n73, n12));
  n75 = bitcmp(bitand(n73, n12));
  n77 = bitor(bitand(n6, n20), bitand(bitcmp(n6), n41));
  n83 = bitand(n63, n37);
  n86 = bitor(n71, n46);
  n93 = n49;
  n98 = bitcmp(bitor(n77, bitor(n86, n18)));
  n126 = bitcmp(bitor(n93, bitor(n74, n75)));
  n133 = bitcmp(bitand(n61, bitand(n62, n39)));
  n148 = bitand(n14, n16);
  n206 = bitor(n133, n66);
  n257 = bitand(n18, n12);
  n264 = bitand(n12, n18);
  ...
  n405 = bitcmp(bitand(n93, n98));
  n414 = bitxor(n55, n282);
  n415 = bitand(n55, n282);
  n457 = bitcmp(bitor(n257, n206));
  n514 = bitand(n10, n20);
  n532 = bitand(n12, n20);
  n548 = bitand(n14, n20);
  n633 = bitor(n257, n54);
  ...
  n1099 = n365;
  n1114 = bitor(bitand(n1099, n764), bitand(bitcmp(n1099), n405));
  ...
  n1382 = bitxor(bitxor(n1132, n1248), n457);
  n1383 = bitor(bitor(bitand(n1132, n1248), bitand(n1248, n457)), bitand(n1132, n457));
