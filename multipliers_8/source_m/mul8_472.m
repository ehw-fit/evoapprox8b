...
%  EP = 96.9 %
  ...
  n35 = bitcmp(bitand(n8, bitand(n24, n10)));
  n37 = bitcmp(bitor(n18, bitor(n28, n6)));
  n38 = bitcmp(bitor(n18, bitor(n34, n10)));
  n41 = bitand(n2, n38);
  n48 = bitcmp(bitand(n28, bitand(n12, n0)));
  n49 = bitcmp(bitand(n28, bitand(n12, n0)));
  n54 = bitcmp(bitor(bitand(n35, n48), n18));
  n73 = n33;
