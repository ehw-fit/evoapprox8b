...
function [ c ] = mul8_002( a, b )
% Approximate function mul8_002
%  Library = EvoApprox8b
%  Circuit = mul8_002
%  Area   (180) = 6715
%  Delay  (180) = 2.350
...
%  EP = 98.5 %
  ...
  n49 = bitcmp(n18);
  n50 = bitcmp(bitor(n10, n36));
  n51 = bitcmp(bitor(n10, n36));
  ...
  n97 = bitcmp(n41);
  n106 = bitcmp(bitor(bitand(n71, n60), n75));
  n110 = bitcmp(bitand(n79, n0));
  n113 = bitcmp(bitxor(n18, n70));
  ...
  n163 = bitor(n121, n88);
  n222 = bitcmp(bitor(n79, n92));
  n233 = bitcmp(bitand(n113, bitand(n134, n22)));
  n238 = n163;
