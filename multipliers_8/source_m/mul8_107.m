...
function [ c ] = mul8_107( a, b )
% Approximate function mul8_107
%  Library = EvoApprox8b
%  Circuit = mul8_107
%  Area   (180) = 8552
%  Delay  (180) = 3.470
...
%  EP = 96.6 %
  ...
  n32 = bitand(n0, n16);
  n33 = bitand(n0, n16);
  n34 = bitcmp(bitand(n26, bitand(n28, n33)));
  n35 = bitcmp(bitand(n26, bitand(n28, n33)));
  n36 = bitcmp(bitand(n10, n4));
  n38 = bitcmp(bitor(bitand(n26, n36), n35));
  n39 = bitcmp(bitor(bitand(n26, n36), n35));
  n41 = bitand(n33, n38);
  n45 = bitand(n2, n28);
  n46 = bitcmp(bitor(n6, bitor(n8, n34)));
  n47 = bitcmp(bitor(n6, bitor(n8, n34)));
  n49 = bitcmp(bitor(bitand(n18, n39), n35));
  ...
  n65 = bitcmp(bitor(bitand(n18, n12), n35));
  n66 = n39;
  n67 = n39;
  n76 = bitand(n6, n66);
  n89 = n65;
  n90 = bitand(n67, n64);
  n93 = bitcmp(bitxor(n45, n28));
  n99 = bitand(n93, n28);
  n106 = bitand(n55, n64);
  n121 = bitor(bitor(bitand(n12, n28), bitand(n28, n99)), bitand(n12, n99));
  n134 = bitand(n14, n16);
  n150 = bitand(n0, n76);
  n197 = bitcmp(n45);
  n224 = bitand(n10, n18);
