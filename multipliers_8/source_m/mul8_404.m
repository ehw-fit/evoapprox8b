...
%  EP = 99.0 %
  ...
  n950 = bitand(n12, n30);
  n964 = bitand(n14, n30);
  n1034 = bitcmp(bitor(bitand(n921, n920), n191));
  n1107 = n491;
  ...
  n1246 = bitcmp(bitor(n41, n1034));
  n1335 = bitcmp(bitor(n817, bitor(n62, n169)));
  ...
  c = bitor(c, bitshift(bitand(n765, 1), 4));
