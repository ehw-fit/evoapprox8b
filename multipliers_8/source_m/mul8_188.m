...
%  EP = 97.8 %
  ...
  n38 = bitcmp(bitor(n4, bitor(n34, n22)));
  n39 = bitcmp(bitor(n4, bitor(n34, n22)));
  n41 = bitand(n18, n28);
  n49 = bitcmp(bitand(n41, n39));
  n51 = bitcmp(n39);
  n54 = bitcmp(n49);
  n55 = bitcmp(n49);
  n57 = bitor(bitor(bitand(n38, n54), bitand(n54, n51)), bitand(n38, n51));
  n61 = bitcmp(bitand(bitor(n18, n4), n55));
  n62 = bitcmp(bitand(n55, n24));
  n69 = bitcmp(bitor(n10, n34));
  n70 = bitcmp(bitor(n61, n62));
  n72 = bitcmp(bitand(n2, n28));
  n73 = bitcmp(bitand(n2, n28));
  n83 = bitand(n18, n54);
  n101 = bitcmp(bitor(n57, n38));
  n123 = bitcmp(n101);
  n131 = bitand(n69, n39);
  n282 = bitor(bitand(n14, n18), bitand(bitcmp(n14), n39));
  n393 = bitcmp(bitand(n18, bitand(n38, n83)));
  ...
  c = bitor(c, bitshift(bitand(n649, 1), 0));
