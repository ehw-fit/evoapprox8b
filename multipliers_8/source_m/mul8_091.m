...
function [ c ] = mul8_091( a, b )
% Approximate function mul8_091
%  Library = EvoApprox8b
%  Circuit = mul8_091
%  Area   (180) = 8468
%  Delay  (180) = 5.360
...
%  EP = 44.5 %
  ...
  n32 = bitand(n0, n16);
  n33 = bitand(n0, n16);
  n38 = bitcmp(bitor(n4, bitor(n28, n8)));
  n41 = bitcmp(bitand(n38, n28));
  n47 = bitor(bitand(n6, n26), bitand(bitcmp(n6), n41));
  n49 = bitand(n2, n16);
  n61 = bitcmp(bitand(n10, bitand(n6, n22)));
  n73 = bitcmp(bitor(n33, bitor(n47, n32)));
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  ...
  n164 = bitand(n0, n18);
  n169 = n49;
  n182 = bitcmp(bitand(n73, n18));
  n183 = bitcmp(bitand(n73, n18));
  n198 = bitand(n4, n18);
  n214 = bitand(n6, n18);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
