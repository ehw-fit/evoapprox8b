...
%  EP = 98.5 %
  ...
  n32 = bitand(n28, n14);
  n33 = bitand(n28, n14);
  n34 = bitcmp(bitand(n2, n32));
  n38 = bitcmp(bitor(n6, bitor(n34, n14)));
  n39 = bitcmp(bitor(n6, bitor(n34, n14)));
  n51 = bitand(n26, n38);
  n63 = bitcmp(bitand(n39, n12));
  n99 = n63;
  ...
  c = bitor(c, bitshift(bitand(n1866, 1), 5));
  c = bitor(c, bitshift(bitand(n1632, 1), 6));
  c = bitor(c, bitshift(bitand(n1732, 1), 7));
