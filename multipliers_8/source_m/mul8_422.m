...
function [ c ] = mul8_422( a, b )
% Approximate function mul8_422
%  Library = EvoApprox8b
%  Circuit = mul8_422
%  Area   (180) = 7344
%  Delay  (180) = 6.130
...
%  EP = 89.5 %
  ...
  n33 = bitand(n0, n16);
  n34 = bitcmp(bitand(n6, n18));
  n75 = bitcmp(bitor(n6, bitor(n0, n26)));
  n82 = bitand(n6, n20);
  n107 = bitcmp(bitor(n75, n34));
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  n148 = bitand(n14, n16);
  n232 = bitand(n8, n18);
  ...
  n398 = bitxor(bitxor(n148, n264), n365);
  n399 = bitor(bitor(bitand(n148, n264), bitand(n264, n365)), bitand(n148, n365));
  ...
  n532 = bitand(n12, n20);
  n548 = bitand(n14, n20);
  n599 = bitor(n107, n464);
  n614 = bitxor(bitxor(n364, n82), n599);
  n615 = bitor(bitor(bitand(n364, n82), bitand(n82, n599)), bitand(n364, n599));
  ...
  n798 = bitand(n12, n22);
  n814 = bitand(n14, n22);
  n832 = bitor(n233, n698);
  n848 = bitxor(n665, n714);
  n849 = bitand(n665, n714);
  ...
  c = bitor(c, bitshift(bitand(n1433, 1), 0));
  c = bitor(c, bitshift(bitand(n298, 1), 1));
  c = bitor(c, bitshift(bitand(n1075, 1), 2));
