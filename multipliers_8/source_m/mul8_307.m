...
function [ c ] = mul8_307( a, b )
% Approximate function mul8_307
%  Library = EvoApprox8b
%  Circuit = mul8_307
%  Area   (180) = 7432
%  Delay  (180) = 5.170
...
%  EP = 89.4 %
  ...
  n33 = bitand(n0, n16);
  n34 = bitcmp(bitand(n4, n18));
  n41 = n33;
  n71 = bitand(n18, n0);
  n75 = bitcmp(bitor(n6, bitor(n0, n10)));
  n82 = bitand(n6, n20);
  ...
  c = bitor(c, bitshift(bitand(n1833, 1), 0));
