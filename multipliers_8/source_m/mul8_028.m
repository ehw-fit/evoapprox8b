...
function [ c ] = mul8_028( a, b )
% Approximate function mul8_028
%  Library = EvoApprox8b
%  Circuit = mul8_028
%  Area   (180) = 6537
%  Delay  (180) = 4.880
...
%  EP = 94.7 %
  ...
  n49 = bitcmp(n46);
  n50 = bitcmp(bitor(bitand(n39, n8), n39));
  n65 = bitor(bitor(bitand(n41, n38), bitand(n38, n35)), bitand(n41, n35));
  n67 = bitcmp(bitand(n47, bitand(n12, n41)));
  n69 = bitcmp(n41);
