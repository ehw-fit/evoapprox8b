...
function [ c ] = mul8_114( a, b )
% Approximate function mul8_114
%  Library = EvoApprox8b
%  Circuit = mul8_114
%  Area   (180) = 8423
%  Delay  (180) = 5.310
...
%  EP = 68.0 %
  ...
  n40 = bitcmp(bitand(n28, n38));
  n46 = bitcmp(bitand(bitor(n37, n26), n2));
  n54 = bitcmp(bitor(bitand(n30, n40), n36));
  n61 = bitcmp(bitand(n2, bitand(n6, n22)));
  n65 = bitand(n4, n54);
  n81 = n18;
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n54);
  n100 = bitcmp(bitand(n61, bitand(n46, n22)));
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  n137 = n65;
  n148 = bitand(n14, n16);
