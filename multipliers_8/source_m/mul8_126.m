...
function [ c ] = mul8_126( a, b )
% Approximate function mul8_126
%  Library = EvoApprox8b
%  Circuit = mul8_126
%  Area   (180) = 6405
%  Delay  (180) = 4.340
...
%  EP = 96.0 %
  ...
  n38 = bitcmp(bitor(n30, bitor(n34, n2)));
  n39 = bitcmp(bitor(n30, bitor(n34, n2)));
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(bitor(n2, n16), n41));
  n49 = bitcmp(bitor(n46, bitor(n12, n0)));
  n56 = bitcmp(bitand(n2, n39));
  n65 = bitand(n18, n38);
  n69 = bitcmp(n2);
  n82 = bitand(n6, n20);
  n102 = bitcmp(bitand(bitor(n26, n56), n35));
  n114 = bitand(n41, n16);
  n115 = bitand(n41, n16);
  n132 = n65;
  n148 = bitand(n14, n16);
  ...
  n1382 = bitxor(n765, n1248);
  n1383 = bitand(n765, n1248);
  ...
  c = bitor(c, bitshift(bitand(n1798, 1), 1));
