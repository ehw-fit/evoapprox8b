...
function [ c ] = mul8_322( a, b )
% Approximate function mul8_322
%  Library = EvoApprox8b
%  Circuit = mul8_322
%  Area   (180) = 8496
%  Delay  (180) = 5.150
...
%  EP = 0.0 %
  ...
  n532 = bitand(n12, n20);
  n548 = bitand(n14, n20);
  n564 = bitxor(n314, n432);
  n565 = bitand(n314, n432);
  n582 = bitxor(bitxor(n332, n448), n565);
  n583 = bitor(bitor(bitand(n332, n448), bitand(n448, n565)), bitand(n332, n565));
  n598 = bitxor(bitxor(n348, n464), n583);
  n599 = bitor(bitor(bitand(n348, n464), bitand(n464, n583)), bitand(n348, n583));
  n614 = bitxor(bitxor(n364, n482), n599);
  n615 = bitor(bitor(bitand(n364, n482), bitand(n482, n599)), bitand(n364, n599));
