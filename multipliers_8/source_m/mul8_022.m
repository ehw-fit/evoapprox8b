...
%  EP = 98.2 %
  ...
  n32 = bitand(n18, n14);
  n33 = bitand(n18, n14);
  n34 = bitcmp(bitand(n26, bitand(n28, n24)));
  n37 = bitand(n12, n34);
  n38 = bitcmp(bitor(n18, bitor(n34, n26)));
  n39 = bitcmp(bitor(n18, bitor(n34, n26)));
  n41 = n38;
  n43 = bitor(bitand(n18, n6), bitand(bitcmp(n18), n37));
  n45 = bitcmp(bitand(n18, bitand(n28, n30)));
  n46 = bitcmp(bitand(bitor(n43, n28), n39));
  n49 = bitcmp(n41);
  n50 = bitcmp(bitand(bitor(n45, n28), n6));
  n55 = bitcmp(n49);
  n61 = bitcmp(bitand(n18, bitand(n12, n22)));
  n62 = bitcmp(n55);
  n63 = bitcmp(n55);
  n70 = bitcmp(bitor(n61, bitor(n4, n12)));
  n72 = bitand(n18, n70);
  n73 = bitand(n18, n70);
  n81 = bitand(n18, n70);
  n82 = bitand(n10, n24);
  n83 = bitand(n10, n24);
  n84 = bitor(n61, n50);
  n89 = bitcmp(bitand(n73, n46));
  n93 = bitcmp(bitand(n18, n82));
  n99 = bitcmp(n63);
  n102 = bitcmp(n63);
  n117 = bitcmp(bitor(n81, n62));
  n123 = bitcmp(bitor(n117, n84));
  n235 = bitand(n10, n102);
  n398 = bitand(n99, n16);
  n399 = bitand(n99, n16);
  n415 = n123;
  n449 = bitcmp(n89);
  ...
  n1164 = bitxor(bitxor(n914, n1032), n815);
  n1165 = bitor(bitor(bitand(n914, n1032), bitand(n1032, n815)), bitand(n914, n815));
