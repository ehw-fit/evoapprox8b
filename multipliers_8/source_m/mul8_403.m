...
function [ c ] = mul8_403( a, b )
% Approximate function mul8_403
%  Library = EvoApprox8b
%  Circuit = mul8_403
%  Area   (180) = 6523
%  Delay  (180) = 4.710
...
%  EP = 94.8 %
  ...
  n38 = bitcmp(bitor(n26, bitor(n34, n26)));
  n39 = bitcmp(bitor(n26, bitor(n34, n26)));
  n41 = bitand(n12, n38);
  n46 = bitcmp(bitand(bitor(n22, n16), n41));
  n47 = bitcmp(bitand(bitor(n22, n16), n41));
  n49 = bitcmp(n46);
  n50 = bitcmp(bitor(bitand(n39, n16), n39));
  n55 = bitcmp(bitand(bitor(n30, n16), n34));
  n65 = bitor(n41, n12);
  n67 = bitor(n47, n12);
  n68 = bitcmp(n41);
  n69 = bitcmp(n41);
  n77 = bitcmp(bitand(n10, n50));
  n82 = bitand(n6, n20);
  n86 = bitcmp(bitand(bitor(n6, n68), n55));
  ...
  n148 = bitand(n14, n16);
  n161 = bitand(n41, n38);
  n221 = bitor(bitand(n14, n82), bitand(bitcmp(n14), n49));
  n232 = bitand(n8, n18);
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
  ...
  n548 = bitand(n14, n20);
  n614 = bitor(n364, n82);
  n632 = bitor(n382, n102);
  n648 = bitor(n398, n514);
  n664 = bitxor(n414, n532);
  n682 = bitxor(bitxor(n415, n548), n161);
  n683 = bitor(bitor(bitand(n415, n548), bitand(n548, n161)), bitand(n415, n161));
  n732 = bitand(n4, n22);
  n748 = bitand(n6, n22);
  n764 = bitand(n8, n22);
  n782 = bitand(n10, n22);
