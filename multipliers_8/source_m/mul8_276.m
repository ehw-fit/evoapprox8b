...
function [ c ] = mul8_276( a, b )
% Approximate function mul8_276
%  Library = EvoApprox8b
%  Circuit = mul8_276
%  Area   (180) = 8336
%  Delay  (180) = 5.300
...
%  EP = 57.4 %
  ...
  n164 = bitand(n0, n18);
  n169 = n65;
  n182 = bitcmp(bitand(n33, bitand(n18, n14)));
  n183 = bitcmp(bitand(n33, bitand(n18, n14)));
  n198 = bitand(n4, n18);
  n214 = bitand(n6, n18);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
