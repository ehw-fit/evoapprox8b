...
function [ c ] = mul8_368( a, b )
% Approximate function mul8_368
%  Library = EvoApprox8b
%  Circuit = mul8_368
%  Area   (180) = 8199
%  Delay  (180) = 4.450
...
%  EP = 77.9 %
  ...
  n38 = bitcmp(n18);
  n54 = bitcmp(bitor(bitand(n30, n38), n36));
  n60 = bitcmp(bitand(bitor(n2, n6), n22));
  n65 = bitand(n4, n54);
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n16);
  n107 = bitor(n10, n60);
  ...
  n164 = bitand(n0, n18);
  n169 = n65;
  n182 = bitcmp(bitand(n137, bitand(n18, n107)));
  n183 = bitcmp(bitand(n137, bitand(n18, n107)));
  n198 = bitand(n4, n54);
  n214 = bitand(n6, n18);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
