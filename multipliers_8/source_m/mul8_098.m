...
function [ c ] = mul8_098( a, b )
% Approximate function mul8_098
%  Library = EvoApprox8b
%  Circuit = mul8_098
%  Area   (180) = 8328
%  Delay  (180) = 4.820
...
%  EP = 56.8 %
  ...
  n46 = bitor(n26, n20);
  n49 = bitand(n2, n16);
  n71 = bitcmp(bitor(bitand(n22, n32), n49));
  n82 = bitand(n6, n16);
  n86 = bitcmp(bitor(bitand(n30, n46), n71));
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  n148 = bitand(n14, n16);
  ...
  n321 = bitand(n169, n86);
  n332 = bitand(n82, n198);
  ...
  n532 = bitand(n12, n20);
  n548 = bitand(n14, n20);
  n564 = bitxor(n321, n432);
  n565 = bitand(n321, n432);
