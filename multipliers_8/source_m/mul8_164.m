...
function [ c ] = mul8_164( a, b )
% Approximate function mul8_164
%  Library = EvoApprox8b
%  Circuit = mul8_164
%  Area   (180) = 5178
%  Delay  (180) = 2.300
...
%  EP = 99.0 %
  ...
  n37 = bitand(n18, n6);
  n38 = bitor(bitand(n22, n0), bitand(bitcmp(n22), n22));
  n40 = bitcmp(bitxor(n12, n12));
  n41 = bitcmp(bitxor(n12, n12));
  n42 = bitcmp(bitand(n6, n28));
  n46 = bitor(bitand(n33, n8), bitand(bitcmp(n33), n37));
  n47 = bitor(bitand(n33, n8), bitand(bitcmp(n33), n37));
  ...
  n65 = n41;
  n66 = n65;
  n68 = bitcmp(bitand(n65, n66));
  n69 = bitcmp(bitand(n65, n66));
  n73 = bitcmp(bitor(n65, n47));
  n82 = bitcmp(bitor(n6, bitor(n4, n14)));
  n83 = bitcmp(bitor(n6, bitor(n4, n14)));
  n87 = bitor(n30, n24);
  n90 = bitcmp(bitor(n87, bitor(n28, n35)));
  ...
  n175 = bitcmp(n83);
  n190 = bitcmp(bitand(bitor(n69, n90), n30));
  n201 = bitcmp(bitor(n97, n38));
  ...
  c = bitor(c, bitshift(bitand(n1734, 1), 1));
