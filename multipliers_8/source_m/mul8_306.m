...
function [ c ] = mul8_306( a, b )
% Approximate function mul8_306
%  Library = EvoApprox8b
%  Circuit = mul8_306
%  Area   (180) = 7416
%  Delay  (180) = 2.900
...
%  EP = 97.6 %
  ...
  n32 = bitcmp(bitor(n28, bitor(n12, n0)));
  n35 = bitcmp(bitand(n2, n18));
  n37 = bitcmp(n18);
  n39 = bitcmp(bitor(bitand(n22, n10), n35));
  n40 = bitcmp(bitor(n18, bitor(n28, n35)));
  n41 = bitcmp(bitor(n18, bitor(n28, n35)));
  n46 = bitand(n39, n8);
  n47 = bitand(n39, n8);
  n49 = bitcmp(bitor(bitand(n28, n12), n6));
  n51 = bitcmp(bitand(n10, n40));
  n57 = bitand(n49, n47);
  n60 = bitand(n37, n16);
  n64 = bitcmp(bitand(n57, n12));
  n65 = bitcmp(bitand(n57, n12));
  n70 = bitand(n47, n64);
  n73 = bitcmp(n65);
  n90 = bitxor(n8, n16);
  n96 = bitcmp(bitor(n57, bitor(n12, n51)));
  n106 = bitand(n41, n28);
  n114 = bitcmp(n37);
  n134 = bitand(n14, n60);
  n135 = bitand(n14, n60);
  n208 = bitand(n41, n12);
  n211 = bitcmp(bitor(n47, n20));
  n230 = bitand(n135, n8);
  n238 = bitand(n12, n18);
  n254 = bitand(n14, n18);
  n304 = bitand(n41, n12);
  ...
  n1246 = bitand(n357, n230);
  n1276 = n1024;
  n1277 = n1024;
  n1290 = bitcmp(n1038);
  n1306 = bitor(n1054, n1039);
  n1307 = bitor(n1054, n1039);
  n1320 = bitxor(bitxor(n1068, n230), n1156);
  n1321 = bitor(bitor(bitand(n1068, n230), bitand(n230, n1156)), bitand(n1068, n1156));
  ...
  n1499 = bitand(n565, n96);
  n1512 = bitand(n1276, n534);
  n1513 = bitand(n1276, n534);
  n1528 = bitcmp(bitor(n1290, bitor(n1277, n211)));
  n1529 = bitcmp(bitor(n1290, bitor(n1277, n211)));
  n1543 = bitor(bitor(bitand(n1306, n304), bitand(n304, n551)), bitand(n1306, n551));
  ...
  n1676 = bitand(n1512, n1499);
  n1690 = bitand(n1528, n1513);
  n1691 = bitand(n1528, n1513);
  n1707 = bitand(n41, n1529);
  ...
  n1855 = n1690;
  n1868 = bitxor(bitxor(n329, n1691), n1855);
  n1869 = bitor(bitor(bitand(n329, n1691), bitand(n1691, n1855)), bitand(n329, n1855));
  n1882 = bitxor(bitxor(n1720, n1707), n1869);
  n1883 = bitor(bitor(bitand(n1720, n1707), bitand(n1707, n1869)), bitand(n1720, n1869));
  n1898 = bitor(bitand(n1883, n1721), bitand(bitcmp(n1883), n1734));
