...
function [ c ] = mul8_477( a, b )
% Approximate function mul8_477
%  Library = EvoApprox8b
%  Circuit = mul8_477
%  Area   (180) = 10511
%  Delay  (180) = 2.510
...
%  EP = 88.1 %
  ...
  n37 = bitxor(n26, n34);
  n38 = bitor(bitand(n10, n0), bitand(bitcmp(n10), n10));
  n39 = bitor(bitand(n10, n0), bitand(bitcmp(n10), n10));
  n40 = bitxor(n18, n28);
  n41 = bitxor(n18, n28);
  n43 = bitand(n39, n40);
  n46 = bitand(n14, n16);
