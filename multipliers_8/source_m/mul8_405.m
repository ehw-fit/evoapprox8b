...
function [ c ] = mul8_405( a, b )
% Approximate function mul8_405
%  Library = EvoApprox8b
%  Circuit = mul8_405
%  Area   (180) = 6773
%  Delay  (180) = 5.970
...
%  EP = 95.9 %
  ...
  n34 = bitcmp(bitand(n33, bitand(n32, n14)));
  n35 = bitcmp(bitand(n33, bitand(n32, n14)));
  ...
  n94 = bitcmp(bitand(bitor(n10, n67), n67));
  n95 = bitcmp(bitand(bitor(n10, n67), n67));
  ...
  n210 = bitand(n95, n46);
  n221 = bitor(bitor(bitand(n18, n182), bitand(n182, n14)), bitand(n18, n14));
  n248 = bitand(n10, n18);
  n264 = bitand(n12, n18);
  n282 = bitand(n14, n18);
