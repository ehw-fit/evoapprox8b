...
function [ c ] = mul8_438( a, b )
% Approximate function mul8_438
%  Library = EvoApprox8b
%  Circuit = mul8_438
%  Area   (180) = 8152
%  Delay  (180) = 3.600
...
%  EP = 96.3 %
  ...
  n32 = bitand(n18, n12);
  n33 = bitand(n18, n12);
  n34 = bitcmp(bitand(n33, bitand(n0, n26)));
  n35 = bitcmp(bitand(n33, bitand(n0, n26)));
  n37 = bitor(bitor(bitand(n10, n6), bitand(n6, n6)), bitand(n10, n6));
  n38 = bitcmp(bitor(bitand(n22, n24), n35));
  n39 = bitcmp(bitor(bitand(n22, n24), n35));
  n41 = bitxor(n12, n12);
  n46 = bitcmp(bitor(bitand(n2, n16), n34));
  n47 = bitcmp(bitor(bitand(n2, n16), n34));
  n49 = bitcmp(bitor(bitand(n18, n38), n35));
  n50 = bitxor(bitxor(n10, n12), n41);
  n54 = bitcmp(bitand(n2, bitand(n24, n30)));
  n55 = bitcmp(bitand(n2, bitand(n24, n30)));
  n57 = bitcmp(bitor(n49, n54));
  n58 = bitcmp(n55);
  n60 = bitand(n41, n58);
  n62 = bitcmp(bitor(n39, bitor(n50, n37)));
  n64 = bitcmp(bitor(bitand(n46, n12), n35));
  n70 = n18;
  n76 = bitand(n6, n16);
  n90 = bitand(n47, n62);
  n106 = bitand(n10, n64);
