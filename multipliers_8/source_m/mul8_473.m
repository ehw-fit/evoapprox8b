...
function [ c ] = mul8_473( a, b )
% Approximate function mul8_473
%  Library = EvoApprox8b
%  Circuit = mul8_473
%  Area   (180) = 8563
%  Delay  (180) = 5.410
...
%  EP = 44.7 %
  ...
  n32 = bitand(n0, n16);
  n38 = bitcmp(bitor(n2, bitor(n24, n14)));
  n39 = bitcmp(bitor(n2, bitor(n24, n14)));
  n41 = bitand(n18, n38);
  n44 = bitcmp(bitand(bitor(n10, n20), n8));
  n49 = bitand(n2, n16);
  n51 = bitand(n30, n44);
  n54 = bitxor(n51, n16);
  n65 = bitand(n4, n54);
  ...
  n314 = bitxor(bitxor(n137, n98), n299);
  n315 = bitor(bitor(bitand(n137, n98), bitand(n98, n299)), bitand(n137, n299));
