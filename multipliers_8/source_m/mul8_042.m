...
function [ c ] = mul8_042( a, b )
% Approximate function mul8_042
%  Library = EvoApprox8b
%  Circuit = mul8_042
%  Area   (180) = 7240
%  Delay  (180) = 5.000
...
%  EP = 90.7 %
  ...
  n1098 = bitxor(n848, n982);
  n1099 = bitand(n848, n982);
  ...
  c = bitor(c, bitshift(bitand(n1049, 1), 0));
  c = bitor(c, bitshift(bitand(n298, 1), 1));
  c = bitor(c, bitshift(bitand(n499, 1), 2));
