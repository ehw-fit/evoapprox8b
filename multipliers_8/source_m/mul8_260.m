...
function [ c ] = mul8_260( a, b )
% Approximate function mul8_260
%  Library = EvoApprox8b
%  Circuit = mul8_260
%  Area   (180) = 6751
%  Delay  (180) = 2.460
...
%  EP = 98.5 %
  ...
  n43 = bitcmp(bitor(n6, bitor(n4, n37)));
  n49 = bitcmp(bitand(n41, bitand(n12, n6)));
  n50 = bitcmp(bitor(n8, n36));
  n51 = bitcmp(bitor(n8, n36));
  ...
  n62 = n41;
  n63 = n41;
  n70 = bitcmp(bitand(n10, n63));
  n71 = bitcmp(bitand(n10, n63));
  n75 = bitcmp(n57);
  n78 = bitcmp(bitor(n63, n60));
  n79 = bitcmp(bitor(n63, n60));
  n81 = bitand(n57, n12);
  n83 = bitand(n63, n60);
  n86 = n63;
  n88 = bitor(bitand(n51, n62), bitand(bitcmp(n51), n81));
  n89 = bitor(bitand(n51, n62), bitand(bitcmp(n51), n81));
  n92 = bitcmp(bitor(n89, n62));
  n93 = bitcmp(bitor(n89, n62));
  n97 = bitcmp(n41);
  n106 = bitcmp(bitor(bitand(n71, n12), n75));
  n110 = bitcmp(bitand(n79, n0));
  n115 = bitcmp(bitand(bitor(n6, n86), n49));
  n121 = bitand(n89, n16);
  n122 = bitcmp(bitor(n93, n106));
  n128 = bitand(n110, n86);
  n129 = bitand(n110, n86);
  n134 = bitand(n61, n78);
  n147 = bitcmp(bitand(n83, n86));
  n150 = bitor(bitand(n115, n16), bitand(bitcmp(n115), n22));
  n153 = n129;
  n160 = bitcmp(bitor(n18, n12));
  n163 = bitor(n121, n88);
  n222 = bitcmp(bitor(n43, n92));
  n233 = bitcmp(bitand(n81, bitand(n134, n22)));
  n238 = n163;
  n253 = bitcmp(bitor(n97, n122));
  n254 = bitand(n14, n18);
  n273 = bitcmp(bitor(n18, n12));
  n274 = bitcmp(bitand(n129, n134));
  n294 = n41;
  n313 = bitcmp(n233);
  n339 = bitcmp(bitand(n75, n160));
  n352 = bitor(bitand(n147, n12), bitand(bitcmp(n147), n313));
  n356 = bitand(n12, n20);
  n372 = bitand(n14, n20);
  n374 = n97;
  n417 = bitcmp(bitor(n4, bitor(n150, n128)));
  n432 = bitcmp(bitor(n153, n70));
  n435 = n55;
  n446 = bitand(n8, n22);
  n460 = bitand(n10, n22);
  n476 = bitand(n12, n22);
  n490 = bitand(n14, n22);
  n505 = bitand(n417, n294);
  n550 = bitand(n6, n24);
  n564 = bitand(n8, n24);
  n580 = bitand(n10, n24);
  n594 = bitand(n12, n24);
  n608 = bitand(n14, n24);
  n625 = bitand(n0, n26);
  n633 = bitcmp(bitor(bitand(n273, n222), n339));
  n654 = bitand(n4, n26);
  n668 = bitand(n6, n26);
  n669 = bitand(n6, n26);
  n682 = bitand(n8, n26);
  ...
  n964 = bitand(n14, n30);
  n1009 = n633;
  n1068 = bitxor(bitxor(n134, n238), n435);
  ...
  n1528 = bitor(n1449, n1277);
  n1556 = bitxor(bitxor(n1320, n1434), n1483);
  ...
  n1854 = bitxor(n1690, n106);
  n1868 = bitxor(n253, n1691);
  n1882 = bitor(bitand(n633, n274), bitand(bitcmp(n633), n1720));
  n1898 = n1734;
