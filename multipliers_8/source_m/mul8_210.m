...
function [ c ] = mul8_210( a, b )
% Approximate function mul8_210
%  Library = EvoApprox8b
%  Circuit = mul8_210
%  Area   (180) = 7808
%  Delay  (180) = 3.430
...
%  EP = 95.9 %
  ...
  n32 = bitand(n18, n16);
  n33 = bitand(n18, n16);
  n34 = bitcmp(bitand(n33, bitand(n0, n33)));
  n35 = bitcmp(bitand(n33, bitand(n0, n33)));
  n38 = bitcmp(bitor(bitand(n22, n24), n35));
  n41 = bitand(n18, n12);
  n46 = bitcmp(bitor(n2, bitor(n16, n34)));
  n47 = bitcmp(bitor(n2, bitor(n16, n34)));
  n49 = bitcmp(bitor(bitand(n18, n38), n35));
  n54 = bitcmp(bitand(n2, bitand(n24, n30)));
  n57 = bitcmp(bitor(n49, n54));
  n64 = bitcmp(bitor(bitand(n18, n38), n35));
  n76 = bitand(n6, n16);
  n90 = bitand(n47, n64);
  n106 = bitand(n57, n64);
  n121 = bitand(n12, n38);
  ...
  n1261 = bitor(n1008, n1098);
  n1277 = n1024;
  n1290 = bitor(n1038, n1025);
  n1291 = bitor(n1038, n1025);
  ...
  n1512 = bitxor(n57, n1261);
  n1513 = bitand(n57, n1261);
  n1528 = bitxor(n1290, n1277);
  n1529 = bitxor(n1290, n1277);
