...
function [ c ] = mul8_342( a, b )
% Approximate function mul8_342
%  Library = EvoApprox8b
%  Circuit = mul8_342
%  Area   (180) = 8564
%  Delay  (180) = 5.430
...
%  EP = 43.8 %
  ...
  n32 = bitand(n0, n16);
  n33 = bitand(n0, n16);
  n35 = bitcmp(bitor(n22, n16));
  n36 = bitcmp(bitand(n33, bitand(n22, n30)));
  n37 = bitcmp(bitand(n33, bitand(n22, n30)));
  n38 = bitcmp(bitor(n18, bitor(n28, n22)));
  n49 = bitand(n2, n16);
  n54 = bitcmp(bitor(bitand(n26, n16), n36));
  n55 = bitcmp(bitor(bitand(n26, n16), n36));
  n57 = bitcmp(bitor(bitand(n18, n38), n35));
  n61 = bitcmp(bitand(n37, bitand(n28, n55)));
  n65 = bitand(n4, n54);
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n16);
  ...
  n137 = n65;
  n148 = bitand(n14, n16);
  n155 = bitcmp(bitor(n57, n32));
  n164 = bitand(n0, n18);
  n169 = n49;
  n182 = bitcmp(bitand(n14, bitand(n18, n155)));
  n198 = bitand(n4, n18);
  n214 = bitand(n6, n18);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
