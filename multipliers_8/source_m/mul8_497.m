...
function [ c ] = mul8_497( a, b )
% Approximate function mul8_497
%  Library = EvoApprox8b
%  Circuit = mul8_497
%  Area   (180) = 6264
%  Delay  (180) = 4.910
...
%  EP = 96.4 %
  ...
  n36 = bitcmp(bitand(n12, bitand(n4, n35)));
  n38 = bitcmp(bitor(n2, bitor(n34, n18)));
  n39 = bitcmp(bitor(n2, bitor(n34, n18)));
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(bitor(n26, n8), n41));
  n47 = bitcmp(bitand(bitor(n26, n8), n41));
  n48 = bitcmp(n46);
  n49 = bitcmp(n46);
  ...
  n77 = bitcmp(n10);
  n82 = bitand(n6, n48);
  n90 = bitcmp(bitand(bitor(n49, n20), n67));
  n93 = bitcmp(bitor(n65, n90));
  n94 = bitcmp(bitor(bitand(n77, n36), n65));
