...
%  EP = 98.2 %
  ...
  n32 = bitand(n18, n14);
  n33 = bitand(n18, n14);
  n36 = bitcmp(bitor(n26, bitor(n4, n30)));
  n38 = bitcmp(bitor(n18, bitor(n8, n6)));
  n41 = bitand(n2, n28);
  n51 = bitand(n38, n30);
  n57 = bitcmp(n41);
  n62 = bitcmp(bitand(n24, bitand(n8, n10)));
  n65 = bitor(bitor(bitand(n62, n12), bitand(n12, n51)), bitand(n62, n51));
  n67 = bitcmp(n33);
  n79 = bitor(bitand(n18, n32), bitand(bitcmp(n18), n30));
  n83 = bitand(n79, n36);
  n89 = bitcmp(bitor(n65, n62));
  n113 = n89;
  n145 = bitand(n57, n12);
