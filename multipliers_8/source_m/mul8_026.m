...
function [ c ] = mul8_026( a, b )
% Approximate function mul8_026
%  Library = EvoApprox8b
%  Circuit = mul8_026
%  Area   (180) = 12183
%  Delay  (180) = 2.950
...
%  EP = 93.3 %
  ...
  n62 = bitand(n10, n16);
  n68 = bitand(n12, n16);
  n73 = bitcmp(bitand(bitor(n2, n54), n0));
  n74 = bitand(n14, n32);
  n82 = bitand(n0, n18);
  n85 = bitand(n10, n74);
  n88 = bitand(n2, n18);
  ...
  n432 = bitxor(n38, n82);
  n433 = bitand(n38, n82);
  n438 = bitxor(bitxor(n44, n88), n85);
  n439 = bitor(bitor(bitand(n44, n88), bitand(n88, n85)), bitand(n44, n85));
  n444 = bitor(bitand(n138, n94), bitand(bitcmp(n138), n50));
  n445 = bitor(bitand(n138, n94), bitand(bitcmp(n138), n50));
  n452 = bitxor(bitxor(n56, n100), n144);
  n453 = bitor(bitor(bitand(n56, n100), bitand(n100, n144)), bitand(n56, n144));
  n458 = bitand(n62, n106);
  n459 = bitand(n62, n106);
  ...
  n746 = bitxor(bitxor(n676, n671), n703);
  n747 = bitor(bitor(bitand(n676, n671), bitand(n671, n703)), bitand(n676, n703));
  ...
  n802 = bitxor(n57, n727);
  n803 = bitand(n57, n727);
  ...
  n958 = bitand(n815, n952);
  n966 = bitor(n958, n946);
  n996 = bitand(n697, n90);
  n1010 = n821;
  n1016 = n996;
