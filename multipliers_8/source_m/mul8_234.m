...
function [ c ] = mul8_234( a, b )
% Approximate function mul8_234
%  Library = EvoApprox8b
%  Circuit = mul8_234
%  Area   (180) = 5385
%  Delay  (180) = 2.320
...
%  EP = 99.1 %
  ...
  n65 = n41;
  n67 = n65;
  n68 = bitcmp(bitor(n65, n54));
  n69 = bitcmp(bitor(n65, n54));
  n71 = bitcmp(n69);
  n73 = bitand(n18, n12);
  n76 = bitcmp(bitand(bitor(n65, n4), n51));
  ...
  n137 = bitor(bitand(n51, n119), bitand(bitcmp(n51), n46));
