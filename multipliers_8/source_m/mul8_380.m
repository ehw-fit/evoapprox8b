...
function [ c ] = mul8_380( a, b )
% Approximate function mul8_380
%  Library = EvoApprox8b
%  Circuit = mul8_380
%  Area   (180) = 6728
%  Delay  (180) = 6.200
...
%  EP = 95.1 %
  ...
  n37 = bitcmp(bitand(n12, bitand(n4, n35)));
  n38 = bitcmp(bitor(n2, bitor(n34, n14)));
  n39 = bitcmp(bitor(n2, bitor(n34, n14)));
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(bitor(n14, n20), n41));
  n47 = bitcmp(bitand(bitor(n14, n20), n41));
  n48 = bitcmp(bitor(n46, bitor(n12, n0)));
  n49 = bitcmp(bitor(n46, bitor(n12, n0)));
  n50 = bitcmp(bitor(bitand(n39, n16), n41));
  n65 = bitcmp(bitand(n18, n39));
  n67 = bitor(bitor(bitand(n47, n48), bitand(n48, n41)), bitand(n47, n41));
  n69 = bitcmp(n2);
  n82 = bitand(n6, n48);
  n90 = bitcmp(bitand(bitor(n49, n20), n14));
  n93 = bitcmp(bitor(n65, n90));
  n102 = bitcmp(bitand(bitor(n26, n50), n35));
  n103 = bitcmp(bitand(bitor(n26, n50), n35));
  n114 = n103;
  n115 = n103;
  n117 = bitcmp(bitor(n37, bitor(n114, n67)));
  n132 = bitand(n117, n16);
  n148 = bitand(n14, n16);
  n182 = bitand(n93, n0);
  n221 = bitor(n49, n82);
  n248 = bitand(n10, n18);
