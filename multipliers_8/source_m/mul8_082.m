...
function [ c ] = mul8_082( a, b )
% Approximate function mul8_082
%  Library = EvoApprox8b
%  Circuit = mul8_082
%  Area   (180) = 6051
%  Delay  (180) = 3.830
...
%  EP = 97.1 %
  ...
  n33 = bitcmp(bitand(n28, n12));
  n34 = bitcmp(bitand(bitor(n2, n20), n10));
  n37 = bitcmp(bitor(n18, bitor(n22, n14)));
  n39 = bitcmp(bitor(n6, bitor(n34, n10)));
  n41 = bitand(n2, n39);
  n49 = bitcmp(bitand(n41, bitand(n14, n6)));
  n54 = bitcmp(n49);
  n57 = bitcmp(bitor(n33, bitor(n28, n22)));
  n72 = bitand(n18, n28);
  n83 = bitand(n18, n37);
  n93 = n49;
  n97 = bitcmp(bitand(n57, n12));
  n99 = bitcmp(bitor(n18, n72));
  n148 = bitand(n14, n16);
  n197 = n97;
  n206 = bitcmp(n99);
  n264 = bitand(n12, n18);
