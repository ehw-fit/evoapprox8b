...
function [ c ] = mul8_116( a, b )
% Approximate function mul8_116
%  Library = EvoApprox8b
%  Circuit = mul8_116
%  Area   (180) = 7944
%  Delay  (180) = 4.750
...
%  EP = 74.5 %
  ...
  n535 = bitcmp(n399);
  n548 = bitand(n14, n20);
  n564 = bitor(bitand(n535, n432), bitand(bitcmp(n535), n81));
  ...
  n848 = bitor(bitand(n833, n714), bitand(bitcmp(n833), n598));
  n849 = bitor(bitand(n833, n714), bitand(bitcmp(n833), n598));
