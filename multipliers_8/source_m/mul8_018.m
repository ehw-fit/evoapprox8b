...
function [ c ] = mul8_018( a, b )
% Approximate function mul8_018
%  Library = EvoApprox8b
%  Circuit = mul8_018
%  Area   (180) = 5303
%  Delay  (180) = 2.300
...
%  EP = 99.1 %
  ...
  n45 = bitor(bitand(n30, n4), bitand(bitcmp(n30), n18));
  n47 = bitand(n45, n8);
  ...
  n126 = bitcmp(bitand(bitor(n30, n64), n91));
  ...
  n261 = bitcmp(n61);
  n277 = bitcmp(bitand(bitor(n37, n126), n51));
  n297 = bitcmp(n49);
  n301 = n69;
  n306 = bitor(n22, n20);
  n325 = bitor(n301, n42);
