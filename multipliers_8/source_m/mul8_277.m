...
function [ c ] = mul8_277( a, b )
% Approximate function mul8_277
%  Library = EvoApprox8b
%  Circuit = mul8_277
%  Area   (180) = 12564
%  Delay  (180) = 3.280
...
%  EP = 85.4 %
  ...
  n53 = bitand(n18, n28);
  n56 = bitand(n8, n16);
  n59 = bitcmp(bitand(n6, bitand(n24, n53)));
  n62 = bitand(n10, n16);
  n68 = bitand(n12, n16);
  n73 = bitcmp(bitand(n2, n38));
  n74 = bitand(n14, n16);
  n82 = bitand(n0, n18);
  n88 = bitand(n2, n18);
  n94 = bitand(n4, n18);
  ...
  n665 = bitor(bitor(bitand(n633, n62), bitand(n62, n489)), bitand(n633, n489));
  ...
  n734 = bitxor(n547, n659);
  n735 = bitand(n547, n659);
  ...
  c = bitor(c, bitshift(bitand(n1619, 1), 2));
