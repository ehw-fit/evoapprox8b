...
function [ c ] = mul8_339( a, b )
% Approximate function mul8_339
%  Library = EvoApprox8b
%  Circuit = mul8_339
%  Area   (180) = 10572
%  Delay  (180) = 2.500
...
%  EP = 93.4 %
  ...
  n46 = bitand(n2, n16);
  n47 = bitand(n2, n16);
  n49 = bitcmp(bitand(n28, bitand(n12, n32)));
  n51 = bitand(n4, n20);
  n53 = bitand(n26, n4);
  n54 = bitor(bitand(n18, n32), bitand(bitcmp(n18), n30));
  n57 = bitcmp(bitor(bitand(n49, n38), n35));
  n60 = bitcmp(bitor(n4, bitor(n16, n8)));
  n61 = bitcmp(bitor(n4, bitor(n16, n8)));
  n65 = bitcmp(n41);
  n67 = bitcmp(n37);
  n69 = bitand(n33, n51);
  ...
  n89 = bitor(n65, n38);
  n90 = bitand(n8, n16);
  n95 = bitcmp(bitand(bitor(n39, n20), n71));
  n97 = bitcmp(bitor(n18, n70));
  n100 = bitcmp(bitor(n33, n70));
  ...
  n189 = bitand(n77, n20);
  n191 = bitcmp(bitand(bitor(n165, n76), n103));
  n194 = bitand(n6, n18);
  n208 = bitand(n8, n18);
  n213 = n169;
  n224 = bitand(n10, n18);
  ...
  n352 = bitcmp(n137);
  n356 = bitand(n12, n20);
  n362 = bitcmp(bitor(n281, n136));
  n367 = bitcmp(bitand(bitor(n213, n32), n103));
  n372 = bitand(n14, n20);
  n402 = bitand(n2, n22);
  n432 = bitand(n6, n22);
  n446 = bitand(n8, n22);
  ...
  n476 = bitand(n12, n22);
  n490 = bitand(n14, n22);
  n493 = bitcmp(bitor(bitand(n61, n314), n191));
  n506 = bitand(n0, n132);
  n520 = bitand(n2, n24);
  n534 = bitand(n4, n24);
  n550 = bitand(n6, n24);
  ...
  n1542 = bitxor(bitxor(n1306, n1291), n833);
  n1543 = bitor(bitor(bitand(n1306, n1291), bitand(n1291, n833)), bitand(n1306, n833));
