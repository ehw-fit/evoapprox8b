...
%  EP = 97.8 %
  ...
  n41 = bitand(n12, n38);
  n43 = n41;
  n45 = bitcmp(bitand(n26, bitand(n38, n22)));
  n49 = bitcmp(bitand(n41, n14));
  n50 = bitor(bitand(n2, n28), bitand(bitcmp(n2), n37));
  n54 = bitcmp(bitor(bitand(n49, n34), n6));
  n55 = bitcmp(bitor(bitand(n49, n34), n6));
  n62 = bitcmp(bitand(n54, bitand(n12, n26)));
  n63 = bitcmp(bitand(n54, bitand(n12, n26)));
  n65 = bitcmp(bitor(n62, n54));
  n75 = bitand(n55, n20);
  n79 = bitcmp(n43);
  n110 = bitcmp(n79);
  n117 = bitcmp(n26);
  n119 = bitcmp(bitor(n65, n50));
  n123 = bitcmp(n119);
  n160 = bitcmp(n110);
  n175 = bitcmp(bitor(n117, n160));
  n206 = bitcmp(bitand(bitor(n10, n28), n75));
  n282 = bitor(bitand(n14, n18), bitand(bitcmp(n14), n39));
  n361 = bitand(n41, n206);
  n398 = bitand(n45, n32);
  ...
  n1898 = bitxor(n649, n1764);
  n1899 = bitand(n649, n1764);
