...
function [ c ] = mul8_155( a, b )
% Approximate function mul8_155
%  Library = EvoApprox8b
%  Circuit = mul8_155
%  Area   (180) = 6914
%  Delay  (180) = 2.820
...
%  EP = 98.4 %
  ...
  n60 = bitor(bitand(n39, n4), bitand(bitcmp(n39), n49));
  ...
  n86 = bitcmp(bitand(n47, bitand(n4, n41)));
  n89 = n33;
  n105 = bitor(n70, n12);
  n106 = bitand(n63, n56);
  n113 = bitxor(n89, n71);
