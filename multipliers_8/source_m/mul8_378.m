...
function [ c ] = mul8_378( a, b )
% Approximate function mul8_378
%  Library = EvoApprox8b
%  Circuit = mul8_378
%  Area   (180) = 8300
%  Delay  (180) = 5.170
...
%  EP = 58.7 %
  ...
  n32 = bitand(n0, n16);
  n33 = bitand(n0, n16);
  n36 = bitcmp(bitand(n26, bitand(n28, n30)));
  n40 = bitcmp(bitand(n2, n28));
  n49 = bitand(n2, n16);
  n54 = bitcmp(bitor(n30, bitor(n40, n36)));
  n55 = bitcmp(bitor(n30, bitor(n40, n36)));
  n61 = bitcmp(bitand(n33, bitand(n6, n22)));
  n65 = bitand(n4, n54);
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n32);
  ...
  n164 = bitand(n0, n18);
  n169 = n49;
  n182 = bitcmp(bitand(n14, bitand(n18, n55)));
  n198 = bitand(n4, n18);
  n214 = bitand(n6, n18);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
