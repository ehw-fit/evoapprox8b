...
function [ c ] = mul8_076( a, b )
% Approximate function mul8_076
%  Library = EvoApprox8b
%  Circuit = mul8_076
%  Area   (180) = 9032
%  Delay  (180) = 3.750
...
%  EP = 85.0 %
  ...
  n995 = bitand(n60, n164);
  n1009 = bitor(bitor(bitand(n76, n180), bitand(n180, n282)), bitand(n76, n282));
  n1024 = bitor(bitand(n298, n194), bitand(bitcmp(n298), n90));
  n1025 = bitor(bitand(n298, n194), bitand(bitcmp(n298), n90));
  ...
  n1260 = bitxor(bitxor(n417, n995), n386);
  n1261 = bitor(bitor(bitand(n417, n995), bitand(n995, n386)), bitand(n417, n386));
