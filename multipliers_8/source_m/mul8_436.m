...
function [ c ] = mul8_436( a, b )
% Approximate function mul8_436
%  Library = EvoApprox8b
%  Circuit = mul8_436
%  Area   (180) = 10639
%  Delay  (180) = 2.380
...
%  EP = 88.4 %
  ...
  n32 = bitand(n0, n16);
  n33 = bitand(n0, n16);
  n38 = bitor(bitand(n24, n0), bitand(bitcmp(n24), n10));
  n39 = bitor(bitand(n24, n0), bitand(bitcmp(n24), n10));
  n40 = bitxor(n18, n28);
  n41 = bitxor(n18, n28);
  n43 = bitand(n2, n8);
  n46 = bitand(n14, n16);
  ...
  n51 = bitand(n4, n20);
  n53 = bitand(n26, n4);
  n54 = bitor(bitand(n26, n46), bitand(bitcmp(n26), n30));
  n55 = bitor(bitand(n26, n46), bitand(bitcmp(n26), n30));
  n60 = bitand(n4, n16);
  n61 = bitand(n4, n16);
  n65 = bitand(n28, n38);
  n66 = bitcmp(n55);
  ...
  n72 = bitcmp(bitor(bitand(n18, n46), n51));
  n73 = bitcmp(bitor(bitand(n18, n46), n51));
  n74 = bitcmp(bitand(bitor(n2, n28), n53));
  n76 = bitand(n6, n16);
  n77 = bitand(n6, n16);
  ...
  n90 = bitand(n8, n16);
  n91 = bitand(n8, n16);
  n95 = bitcmp(bitand(n39, n20));
  n97 = bitcmp(bitor(n73, n70));
  n98 = bitcmp(bitand(n91, n24));
  n100 = bitcmp(bitor(bitand(n33, n70), n47));
  n101 = bitcmp(bitor(bitand(n33, n70), n47));
  n105 = bitcmp(n97);
  n106 = bitand(n10, n16);
  n108 = bitcmp(bitor(n97, bitor(n74, n6)));
  n110 = bitand(n101, n88);
  n113 = bitcmp(bitor(bitand(n105, n54), n83));
  n121 = bitand(n12, n16);
  n125 = bitor(bitand(n108, n66), bitand(bitcmp(n108), n53));
  n126 = bitor(bitand(n95, n100), bitand(bitcmp(n95), n47));
  n131 = bitcmp(bitand(n0, bitand(n125, n55)));
  n134 = bitand(n14, n16);
  n150 = bitand(n0, n18);
  n153 = bitxor(n97, n110);
  n164 = bitand(n65, n18);
  n167 = bitcmp(bitand(n113, n40));
  n177 = n153;
  n180 = bitand(n4, n18);
  ...
  n272 = bitor(bitand(n6, n86), bitand(bitcmp(n6), n233));
  n282 = bitand(n2, n20);
  n298 = bitand(n4, n272);
  n312 = bitand(n6, n20);
  n314 = bitcmp(n67);
  ...
  n432 = bitand(n6, n22);
  n446 = bitand(n8, n22);
  n449 = bitcmp(bitor(n185, bitor(n134, n323)));
  n456 = bitcmp(n105);
  n460 = bitand(n10, n22);
  n476 = bitand(n12, n22);
  n490 = bitand(n14, n22);
  ...
  n1290 = bitxor(bitxor(n1038, n1025), n995);
  n1291 = bitor(bitor(bitand(n1038, n1025), bitand(n1025, n995)), bitand(n1038, n995));
