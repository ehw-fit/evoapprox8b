...
function [ c ] = mul8_180( a, b )
% Approximate function mul8_180
%  Library = EvoApprox8b
%  Circuit = mul8_180
%  Area   (180) = 6573
%  Delay  (180) = 5.580
...
%  EP = 94.9 %
  ...
  n39 = bitcmp(bitor(n26, bitor(n34, n22)));
  n46 = bitcmp(bitand(bitor(n22, n16), n2));
  n49 = bitcmp(n46);
  n50 = bitcmp(n39);
  n82 = bitand(n6, n20);
  ...
  n1114 = bitxor(bitxor(n864, n1064), n1099);
  n1115 = bitor(bitor(bitand(n864, n1064), bitand(n1064, n1099)), bitand(n864, n1099));
  ...
  c = bitor(c, bitshift(bitand(n1299, 1), 2));
