...
%  EP = 97.8 %
  ...
  n38 = bitcmp(bitor(n6, bitor(n34, n18)));
  n39 = bitcmp(bitor(n6, bitor(n34, n18)));
  n41 = bitand(n38, n28);
  n42 = n6;
  n46 = bitor(n26, n36);
  n49 = bitcmp(bitand(n18, n38));
  n51 = bitor(bitand(n36, n28), bitand(bitcmp(n36), n37));
  n55 = bitand(n30, n42);
  n78 = bitcmp(bitand(bitor(n55, n28), n2));
  n79 = bitcmp(bitand(bitor(n55, n28), n2));
  n81 = n41;
  n83 = bitand(n79, n37);
  n121 = bitor(bitand(n51, n46), bitand(bitcmp(n51), n49));
  n123 = bitcmp(n121);
  n215 = bitcmp(n41);
  n233 = bitand(n2, n46);
  ...
  c = bitor(c, bitshift(bitand(n233, 1), 0));
