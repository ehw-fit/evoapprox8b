...
function [ c ] = mul8_185( a, b )
% Approximate function mul8_185
%  Library = EvoApprox8b
%  Circuit = mul8_185
%  Area   (180) = 9175
%  Delay  (180) = 2.460
...
%  EP = 95.8 %
  ...
  n32 = bitcmp(bitand(n0, n14));
  n33 = bitcmp(bitand(n0, n14));
  n37 = bitxor(n26, n28);
  n38 = bitor(bitand(n18, n24), bitand(bitcmp(n18), n10));
  n40 = bitcmp(bitor(n33, n28));
  n41 = bitcmp(bitor(n33, n28));
  n46 = bitand(n2, n16);
  n47 = bitand(n2, n16);
  n53 = bitcmp(bitand(n18, bitand(n4, n6)));
  n62 = bitand(n8, n32);
  n65 = bitand(n18, n14);
  n66 = bitcmp(bitor(n18, n28));
  n67 = bitcmp(bitor(n18, n28));
  n68 = bitand(n26, n66);
  n69 = bitand(n26, n66);
  n70 = bitcmp(bitand(n41, bitand(n62, n37)));
  n71 = bitcmp(bitand(n41, bitand(n62, n37)));
  n75 = bitcmp(bitand(bitor(n69, n68), n47));
  n76 = bitand(n6, n16);
  n77 = bitand(n6, n16);
  n80 = bitand(n18, n12);
  n86 = bitcmp(n71);
  n89 = bitor(bitand(n40, n12), bitand(bitcmp(n40), n65));
  n90 = bitand(n67, n46);
  n94 = bitcmp(bitand(n65, n20));
  n95 = bitcmp(bitand(n65, n20));
  n97 = bitcmp(bitor(n18, n70));
  n100 = bitcmp(bitor(bitand(n53, n70), n95));
  n102 = bitcmp(bitor(n95, n70));
  n103 = bitcmp(bitor(n95, n70));
  n104 = bitor(n97, n102);
  n105 = bitor(n97, n102);
  n106 = bitand(n103, n16);
  n114 = bitor(n14, n94);
  ...
  n143 = bitand(n41, n90);
  n150 = bitand(n0, n18);
  n164 = bitcmp(bitor(n77, bitor(n18, n75)));
  n169 = bitcmp(bitand(n2, n86));
  n177 = bitcmp(bitor(n121, bitor(n118, n6)));
  n180 = bitand(n4, n18);
  n194 = bitand(n6, n100);
  n201 = bitand(n177, n94);
  n203 = bitcmp(n169);
  n208 = bitand(n8, n18);
  n219 = bitcmp(bitor(n143, n100));
  n224 = bitand(n10, n18);
  n238 = bitand(n12, n18);
  n245 = bitcmp(bitor(n10, n114));
  n254 = bitand(n14, n18);
  ...
  n343 = bitand(n10, n20);
  n356 = bitand(n12, n20);
  n366 = bitor(bitand(n103, n38), bitand(bitcmp(n103), n201));
  n372 = bitand(n14, n20);
  n416 = bitand(n89, n22);
  ...
  n1025 = bitand(n90, n194);
  n1038 = bitxor(n106, n208);
  n1039 = bitxor(n106, n208);
  ...
  n1142 = bitxor(bitxor(n432, n534), n203);
  n1143 = bitor(bitor(bitand(n432, n534), bitand(n534, n203)), bitand(n432, n203));
  ...
  n1318 = bitand(n1307, n668);
  n1320 = bitxor(bitxor(n1009, n1055), n1156);
  n1321 = bitor(bitor(bitand(n1009, n1055), bitand(n1055, n1156)), bitand(n1009, n1156));
  ...
  n1542 = bitxor(bitxor(n1306, n264), n1364);
  n1543 = bitor(bitor(bitand(n1306, n264), bitand(n264, n1364)), bitand(n1306, n1364));
  ...
  c = bitor(c, bitshift(bitand(n1513, 1), 0));
