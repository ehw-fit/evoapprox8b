...
function [ c ] = mul8_051( a, b )
% Approximate function mul8_051
%  Library = EvoApprox8b
%  Circuit = mul8_051
%  Area   (180) = 6569
%  Delay  (180) = 4.350
...
%  EP = 96.8 %
  ...
  n34 = bitcmp(bitand(bitor(n33, n28), n14));
  n35 = bitcmp(bitand(bitor(n33, n28), n14));
  n37 = bitcmp(bitand(n18, bitand(n4, n6)));
  n38 = bitcmp(bitor(n2, bitor(n34, n14)));
  n39 = bitcmp(bitor(n2, bitor(n34, n14)));
  n40 = bitand(n18, n38);
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(bitor(n14, n40), n41));
  n47 = bitcmp(bitand(bitor(n14, n40), n41));
  n48 = bitcmp(bitor(n46, n14));
  n49 = bitcmp(bitor(n46, n14));
  n50 = bitcmp(bitor(bitand(n39, n16), n39));
  n51 = bitcmp(bitor(bitand(n39, n16), n39));
  n53 = bitcmp(bitor(n18, n35));
  n65 = bitor(n46, n39);
  n69 = bitcmp(n53);
  n82 = bitand(n14, n48);
  n93 = bitcmp(bitor(n65, n46));
  n102 = bitcmp(bitand(bitor(n30, n50), n35));
  n103 = bitcmp(bitand(bitor(n30, n50), n35));
  n114 = n103;
  n115 = n103;
  n148 = bitand(n14, n16);
  n182 = bitand(n93, n0);
  ...
  n282 = bitand(n14, n18);
  n283 = bitand(n14, n18);
  n287 = bitor(bitand(n191, n40), bitand(bitcmp(n191), n53));
  n294 = bitcmp(n47);
  n357 = bitcmp(bitor(n37, n20));
  n364 = bitcmp(n114);
  n382 = bitor(n283, n248);
  n398 = bitxor(n148, n264);
  n399 = bitand(n148, n264);
  n414 = bitxor(n399, n282);
  n415 = bitand(n399, n282);
  n446 = bitor(n287, n294);
  n514 = bitand(n10, n20);
  n532 = bitand(n12, n20);
  n548 = bitand(n14, n20);
  n614 = bitor(n364, n446);
  ...
  n832 = n41;
  n845 = bitcmp(n69);
  n864 = bitcmp(bitand(n614, n732));
  n883 = bitor(n632, n748);
  ...
  n1114 = bitcmp(bitxor(n864, n982));
  n1115 = bitcmp(bitxor(n864, n982));
  n1132 = bitor(bitand(n1115, n998), bitand(bitcmp(n1115), n357));
