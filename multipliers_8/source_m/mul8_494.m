...
function [ c ] = mul8_494( a, b )
% Approximate function mul8_494
%  Library = EvoApprox8b
%  Circuit = mul8_494
%  Area   (180) = 6521
%  Delay  (180) = 4.730
...
%  EP = 97.2 %
  ...
  n38 = bitcmp(bitor(n30, bitor(n34, n4)));
  n39 = bitcmp(bitor(n30, bitor(n34, n4)));
  n41 = bitand(n2, n38);
  n46 = bitcmp(bitand(bitor(n22, n16), n41));
  n48 = bitcmp(bitor(n46, n12));
  n49 = bitcmp(bitor(n46, n12));
  n50 = bitcmp(n39);
  n51 = bitcmp(n39);
  ...
  n69 = bitcmp(n41);
  n82 = bitand(n61, n20);
  n85 = bitcmp(bitor(n69, bitor(n46, n6)));
  n86 = bitand(n14, n48);
  n93 = bitcmp(bitor(n10, n46));
  n101 = bitcmp(n85);
  n103 = bitcmp(bitand(bitor(n26, n50), n35));
  n114 = bitcmp(bitor(n103, n50));
  n115 = bitcmp(bitor(n103, n50));
  n121 = bitand(n86, n12);
  n134 = bitor(n69, n114);
  n148 = bitand(n14, n16);
  n182 = bitand(n93, n8);
  ...
  n282 = bitand(n14, n18);
  n294 = bitcmp(n193);
  n337 = bitxor(n121, n294);
  n364 = bitcmp(bitand(n337, n232));
  n365 = bitcmp(bitand(n337, n232));
  ...
  n1132 = bitor(bitand(n1115, n998), bitand(bitcmp(n1115), n101));
  ...
  c = bitor(c, bitshift(bitand(n1648, 1), 3));
