...
function [ c ] = mul8_007( a, b )
% Approximate function mul8_007
%  Library = EvoApprox8b
%  Circuit = mul8_007
%  Area   (180) = 12436
%  Delay  (180) = 3.130
...
%  EP = 62.5 %
  ...
  n38 = bitand(n2, n16);
  n39 = bitand(n2, n16);
  n40 = bitcmp(bitand(n38, n28));
  n41 = bitcmp(bitand(n38, n28));
  n42 = bitcmp(bitand(n18, bitand(n40, n39)));
  n44 = bitand(n4, n16);
  n46 = bitor(bitand(n6, n24), bitand(bitcmp(n6), n39));
  n50 = bitand(n6, n16);
  n54 = bitor(n41, n42);
  n56 = bitand(n8, n16);
  n62 = bitand(n10, n16);
  ...
  n126 = bitand(n14, n18);
  n132 = bitand(n0, n20);
  n137 = bitcmp(bitor(n65, bitor(n54, n6)));
  n138 = bitand(n2, n20);
  n144 = bitand(n4, n20);
  n150 = bitand(n6, n20);
  n156 = bitand(n8, n20);
  ...
  n552 = bitxor(bitxor(n137, n439), n182);
  n553 = bitor(bitor(bitand(n137, n439), bitand(n439, n182)), bitand(n137, n182));
  ...
  n752 = bitxor(bitxor(n684, n677), n483);
  n753 = bitor(bitor(bitand(n684, n677), bitand(n677, n483)), bitand(n684, n483));
