...
%  EP = 98.9 %
  ...
  n65 = n41;
  n67 = n65;
  n68 = bitcmp(bitor(bitand(n65, n4), n67));
  n69 = bitcmp(bitor(bitand(n65, n4), n67));
  ...
  c = bitor(c, bitshift(bitand(n118, 1), 1));
