...
function [ c ] = mul8_193( a, b )
% Approximate function mul8_193
%  Library = EvoApprox8b
%  Circuit = mul8_193
%  Area   (180) = 8824
%  Delay  (180) = 3.770
...
%  EP = 88.5 %
  ...
  n76 = bitand(n6, n16);
  n78 = bitcmp(n30);
  n82 = bitcmp(bitor(n18, n78));
  n83 = bitcmp(bitor(n18, n78));
  n90 = bitand(n8, n16);
  n106 = bitand(n10, n16);
  n121 = bitand(n12, n16);
  n134 = bitand(n14, n16);
  n142 = bitcmp(bitxor(n83, n82));
  n148 = bitor(n18, n142);
  n150 = bitand(n0, n18);
  n164 = bitand(n2, n18);
  n194 = bitand(n6, n148);
  ...
  n1260 = bitxor(n417, n995);
  n1261 = bitxor(n417, n995);
