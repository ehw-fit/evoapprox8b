...
function [ c ] = mul8_291( a, b )
% Approximate function mul8_291
%  Library = EvoApprox8b
%  Circuit = mul8_291
%  Area   (180) = 5629
%  Delay  (180) = 4.150
...
%  EP = 97.6 %
  ...
  n32 = bitand(n18, n12);
  n33 = bitand(n18, n12);
  n34 = bitcmp(bitand(n30, bitand(n32, n6)));
  n37 = bitcmp(bitor(n18, n34));
  n38 = bitcmp(bitor(n6, bitor(n34, n26)));
  n39 = bitcmp(bitor(n6, bitor(n34, n26)));
  n41 = bitand(n33, n30);
  n42 = bitcmp(bitand(bitor(n22, n16), n16));
  n43 = bitcmp(bitand(bitor(n22, n16), n16));
  n44 = bitxor(n42, n43);
  ...
  n101 = bitcmp(bitand(bitor(n77, n47), n88));
  n103 = n101;
  n117 = n49;
