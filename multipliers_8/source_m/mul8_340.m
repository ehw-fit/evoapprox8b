...
function [ c ] = mul8_340( a, b )
% Approximate function mul8_340
%  Library = EvoApprox8b
%  Circuit = mul8_340
%  Area   (180) = 8547
%  Delay  (180) = 4.860
...
%  EP = 51.5 %
  ...
  n32 = bitand(n0, n16);
  n34 = bitcmp(n18);
  n38 = bitcmp(bitor(n34, bitor(n24, n14)));
  n39 = bitcmp(bitor(n34, bitor(n24, n14)));
  n41 = bitand(n2, n30);
  n44 = bitcmp(bitand(bitor(n38, n20), n8));
  n49 = bitand(n2, n16);
  n51 = bitand(n30, n44);
  n54 = bitor(bitand(n30, n16), bitand(bitcmp(n30), n51));
  n65 = bitand(n4, n54);
  n80 = bitor(n41, n39);
  n81 = bitor(n41, n39);
  n82 = bitand(n6, n16);
  ...
  n164 = bitand(n0, n18);
  n169 = n49;
  n182 = bitcmp(bitand(n137, bitand(n80, n81)));
  n183 = bitcmp(bitand(n137, bitand(n80, n81)));
  n198 = bitand(n4, n18);
  n214 = bitand(n6, n18);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
  ...
  n332 = bitxor(bitxor(n82, n198), n83);
  n333 = bitor(bitor(bitand(n82, n198), bitand(n198, n83)), bitand(n82, n83));
