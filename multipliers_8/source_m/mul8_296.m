...
function [ c ] = mul8_296( a, b )
% Approximate function mul8_296
%  Library = EvoApprox8b
%  Circuit = mul8_296
%  Area   (180) = 9404
%  Delay  (180) = 2.490
...
%  EP = 97.1 %
  ...
  n43 = bitor(bitand(n0, n8), bitand(bitcmp(n0), n2));
  n46 = bitand(n2, n16);
  n50 = bitand(n4, n16);
  n51 = bitand(n4, n16);
  ...
  n90 = bitand(n89, n46);
  n91 = bitand(n89, n46);
  n94 = bitcmp(bitand(n65, bitand(n20, n41)));
  n95 = bitcmp(bitand(n65, bitand(n20, n41)));
  ...
  n176 = bitcmp(bitor(n121, bitor(n70, n0)));
  n177 = bitcmp(bitor(n121, bitor(n70, n0)));
  n180 = bitand(n4, n18);
  ...
  n1128 = bitxor(bitxor(n416, n742), n624);
  n1129 = bitor(bitor(bitand(n416, n742), bitand(n742, n624)), bitand(n416, n624));
