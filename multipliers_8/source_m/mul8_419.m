...
function [ c ] = mul8_419( a, b )
% Approximate function mul8_419
%  Library = EvoApprox8b
%  Circuit = mul8_419
%  Area   (180) = 6560
%  Delay  (180) = 5.360
...
%  EP = 95.2 %
  ...
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(bitor(n14, n4), n41));
  n48 = bitcmp(bitor(n46, bitor(n12, n0)));
  n49 = bitcmp(bitor(n46, bitor(n12, n0)));
  n50 = bitcmp(bitand(bitor(n10, n16), n39));
  n51 = bitcmp(bitand(bitor(n10, n16), n39));
  n61 = bitcmp(bitor(bitand(n2, n20), n51));
  n65 = bitand(n41, n39);
  n69 = bitcmp(n2);
  n77 = bitcmp(n61);
  n82 = bitand(n6, n48);
  n93 = bitcmp(bitor(n65, n46));
  n94 = bitcmp(bitand(n77, n36));
