...
function [ c ] = mul8_178( a, b )
% Approximate function mul8_178
%  Library = EvoApprox8b
%  Circuit = mul8_178
%  Area   (180) = 5522
%  Delay  (180) = 2.330
...
%  EP = 99.0 %
  ...
  n54 = bitor(n41, n0);
  n57 = bitor(bitand(n0, n54), bitand(bitcmp(n0), n2));
  n61 = bitcmp(bitand(n12, bitand(n28, n14)));
  n65 = n41;
  n67 = n65;
  n68 = bitcmp(bitor(n65, bitor(n54, n67)));
  n69 = bitcmp(bitor(n65, bitor(n54, n67)));
  n70 = bitcmp(n69);
  n71 = bitcmp(n69);
  n73 = bitcmp(bitor(n65, bitor(n46, n22)));
  n76 = bitcmp(bitand(n57, n70));
  n82 = bitcmp(bitor(n6, bitor(n4, n14)));
  n85 = bitor(bitand(n39, n12), bitand(bitcmp(n39), n53));
  n86 = bitor(n30, n24);
  n87 = bitor(n30, n24);
  ...
  n193 = bitor(n105, n102);
  n201 = bitcmp(bitor(n193, n134));
