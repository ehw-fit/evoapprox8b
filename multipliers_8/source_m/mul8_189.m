...
function [ c ] = mul8_189( a, b )
% Approximate function mul8_189
%  Library = EvoApprox8b
%  Circuit = mul8_189
%  Area   (180) = 8216
%  Delay  (180) = 2.910
...
%  EP = 97.0 %
  ...
  n32 = bitand(n0, n12);
  n33 = bitand(n0, n12);
  n34 = bitcmp(bitand(n10, bitand(n28, n8)));
  n35 = bitcmp(bitand(n10, bitand(n28, n8)));
  n37 = bitand(n12, n30);
  n38 = bitcmp(bitor(bitand(n33, n24), n35));
  n39 = bitcmp(bitor(bitand(n33, n24), n35));
  n41 = bitand(n33, n38);
  n46 = bitcmp(bitor(n2, bitor(n34, n34)));
  n47 = bitcmp(bitor(n2, bitor(n34, n34)));
  n51 = bitcmp(bitand(n10, bitand(n12, n33)));
  n54 = bitcmp(bitand(n2, bitand(n24, n30)));
  n56 = bitcmp(bitor(n46, n54));
  n57 = bitcmp(bitor(n46, n54));
  n61 = bitand(n41, n4);
  n67 = n39;
  n68 = bitcmp(bitand(n37, bitand(n35, n67)));
  n70 = n47;
  n73 = bitcmp(bitor(n41, n28));
  n89 = n33;
  n95 = bitxor(n14, n68);
  n102 = bitor(n73, n56);
  n105 = bitand(n89, n102);
  n106 = bitand(n51, n70);
  n121 = bitand(n12, n38);
  n134 = bitand(n14, n16);
  n150 = bitand(n0, n18);
  ...
  n1143 = bitor(bitor(bitand(n432, n662), bitand(n662, n638)), bitand(n432, n638));
  ...
  n1276 = n1024;
  n1290 = bitand(n1038, n1025);
  n1291 = bitand(n1038, n1025);
  n1306 = bitxor(bitxor(n329, n534), n817);
  n1307 = bitor(bitor(bitand(n329, n534), bitand(n534, n817)), bitand(n329, n817));
  ...
  n1676 = bitor(n229, n654);
  n1677 = bitor(n229, n654);
