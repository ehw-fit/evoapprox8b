...
function [ c ] = mul8_496( a, b )
% Approximate function mul8_496
%  Library = EvoApprox8b
%  Circuit = mul8_496
%  Area   (180) = 8372
%  Delay  (180) = 4.600
...
%  EP = 68.4 %
  ...
  n32 = bitand(n28, n16);
  n33 = bitand(n28, n16);
  n38 = bitcmp(bitor(n10, bitor(n28, n22)));
  n41 = bitcmp(bitand(n38, n28));
  n43 = bitand(n6, n32);
  n46 = bitor(bitand(n6, n26), bitand(bitcmp(n6), n41));
  n49 = bitand(n2, n16);
  n61 = bitcmp(bitand(n26, bitand(n6, n14)));
  n73 = bitcmp(bitor(n33, bitor(n46, n43)));
  n81 = bitcmp(bitand(n41, bitand(n12, n6)));
  n82 = bitand(n6, n16);
  n98 = bitand(n8, n16);
  n114 = bitand(n10, n16);
  n132 = bitand(n12, n16);
  ...
  n164 = bitand(n0, n18);
  n169 = n49;
  n183 = bitcmp(bitand(n73, bitand(n18, n81)));
  n198 = bitand(n4, n18);
  n214 = bitand(n6, n18);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
