...
function [ c ] = mul8_425( a, b )
% Approximate function mul8_425
%  Library = EvoApprox8b
%  Circuit = mul8_425
%  Area   (180) = 5641
%  Delay  (180) = 4.300
...
%  EP = 97.9 %
  ...
  n35 = bitcmp(bitand(n33, bitand(n4, n30)));
  n37 = bitcmp(bitor(n18, n34));
  n38 = bitcmp(bitor(n6, bitor(n34, n16)));
  n39 = bitcmp(bitor(n6, bitor(n34, n16)));
  n41 = bitand(n2, n38);
  n43 = bitcmp(bitand(bitor(n39, n16), n6));
  ...
  n72 = bitcmp(n65);
  n73 = bitcmp(n65);
  n77 = bitcmp(bitand(n18, bitand(n4, n35)));
  n78 = bitcmp(n63);
  n82 = bitand(n55, n37);
  n83 = bitand(n55, n37);
  ...
  n101 = bitcmp(bitand(bitor(n77, n82), n43));
  n103 = n101;
