...
function [ c ] = mul8_426( a, b )
% Approximate function mul8_426
%  Library = EvoApprox8b
%  Circuit = mul8_426
%  Area   (180) = 6012
%  Delay  (180) = 4.170
...
%  EP = 97.3 %
  ...
  n37 = bitcmp(bitor(n18, bitor(n34, n14)));
  n38 = bitcmp(bitor(n14, bitor(n34, n14)));
  n41 = bitand(n2, n38);
  n49 = bitcmp(n41);
  n54 = bitcmp(n49);
  n57 = bitcmp(n49);
  n65 = n57;
  n83 = bitand(n10, n37);
  n86 = bitor(bitand(n65, n28), bitand(bitcmp(n65), n41));
  n89 = bitcmp(bitand(n86, n12));
  n93 = n89;
  ...
  c = bitor(c, bitshift(bitand(n1465, 1), 0));
