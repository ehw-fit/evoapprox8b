...
function [ c ] = mul8_390( a, b )
% Approximate function mul8_390
%  Library = EvoApprox8b
%  Circuit = mul8_390
%  Area   (180) = 6845
%  Delay  (180) = 4.890
...
%  EP = 94.2 %
  ...
  n38 = bitcmp(bitor(n24, n34));
  n41 = bitand(n2, n38);
  n46 = bitcmp(bitand(bitor(n22, n16), n41));
  n65 = bitcmp(bitor(n41, bitor(n12, n6)));
  n69 = bitcmp(n41);
  n74 = bitor(n10, n46);
  n82 = bitand(n6, n20);
  n83 = bitand(n6, n20);
  n102 = bitcmp(bitand(bitor(n26, n74), n35));
  n103 = bitcmp(bitand(bitor(n26, n74), n35));
  n114 = n103;
  n132 = bitand(n12, n16);
  n134 = n35;
  n148 = bitand(n14, n16);
  n169 = bitand(n65, n134);
  n181 = bitcmp(bitor(n41, n74));
  n182 = bitand(n22, n0);
  n232 = bitand(n8, n18);
  n248 = bitand(n10, n18);
  n249 = bitand(n10, n18);
