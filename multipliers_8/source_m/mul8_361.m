...
function [ c ] = mul8_361( a, b )
% Approximate function mul8_361
%  Library = EvoApprox8b
%  Circuit = mul8_361
%  Area   (180) = 5642
%  Delay  (180) = 4.110
...
%  EP = 97.8 %
  ...
  n36 = bitcmp(bitor(n2, n34));
  n37 = bitcmp(bitor(n2, n34));
  ...
  n57 = bitcmp(n41);
  n65 = bitcmp(n57);
  n78 = bitcmp(bitand(bitor(n41, n38), n2));
  n79 = bitcmp(bitand(bitor(n41, n38), n2));
  n81 = n41;
  n83 = bitand(n79, n37);
  n89 = bitcmp(bitand(bitor(n81, n38), n22));
