...
function [ c ] = mul8_080( a, b )
% Approximate function mul8_080
%  Library = EvoApprox8b
%  Circuit = mul8_080
%  Area   (180) = 9592
%  Delay  (180) = 2.890
...
%  EP = 66.0 %
  ...
  n150 = bitand(n0, n18);
  n153 = bitor(n41, n46);
  n155 = bitor(bitor(bitand(n41, n76), bitand(n76, n71)), bitand(n41, n71));
  n164 = bitand(n2, n18);
  n180 = bitand(n4, n18);
  n188 = bitcmp(bitor(n153, bitor(n94, n155)));
  n194 = bitand(n6, n18);
  n197 = bitand(n121, n70);
  n208 = bitand(n8, n18);
  n224 = bitand(n10, n18);
  n238 = bitand(n12, n18);
  n251 = bitand(n197, n188);
  n254 = bitand(n14, n18);
  n268 = bitand(n0, n20);
  n282 = bitand(n2, n20);
  n298 = bitand(n4, n20);
  ...
  n1706 = bitxor(n939, n1529);
  n1707 = bitand(n939, n1529);
  ...
  n1912 = bitxor(bitxor(n1750, n1735), n251);
  n1913 = bitor(bitor(bitand(n1750, n1735), bitand(n1735, n251)), bitand(n1750, n251));
