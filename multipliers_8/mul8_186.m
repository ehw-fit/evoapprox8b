...
function [ c ] = mul8_186( a, b )
% Approximate function mul8_186
%  Library = EvoApprox8b
%  Circuit = mul8_186
%  Area   (180) = 6380
%  Delay  (180) = 3.770
...
%  EP = 97.5 %
  ...
  n32 = bitcmp(bitand(n28, n14));
  n34 = bitcmp(bitand(n18, n8));
  n35 = bitcmp(bitand(n18, n8));
  n37 = bitor(bitand(n32, n12), bitand(bitcmp(n32), n26));
  n38 = bitcmp(bitor(n10, n34));
  n41 = bitand(n2, n38);
  n49 = bitcmp(bitand(n41, bitand(n12, n6)));
  n54 = bitcmp(n35);
  n55 = bitcmp(n35);
  n57 = bitcmp(bitor(n18, n55));
  n58 = n41;
  n61 = bitcmp(n49);
  n77 = n61;
  n78 = bitcmp(n77);
  n83 = bitand(n18, n38);
  n88 = bitcmp(bitand(n49, n78));
  n93 = bitcmp(n77);
  n137 = bitand(n57, n12);
  n146 = bitcmp(n49);
  n148 = bitand(n14, n16);
