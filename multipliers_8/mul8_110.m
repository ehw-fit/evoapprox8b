...
function [ c ] = mul8_110( a, b )
% Approximate function mul8_110
%  Library = EvoApprox8b
%  Circuit = mul8_110
%  Area   (180) = 7380
%  Delay  (180) = 2.920
...
%  EP = 98.1 %
  ...
  n32 = bitcmp(bitor(n18, bitor(n12, n0)));
  ...
  n46 = bitand(n2, n40);
  n47 = bitand(n2, n40);
  n49 = bitcmp(bitor(bitand(n28, n12), n32));
  ...
  n106 = bitand(n41, n28);
  n114 = bitcmp(n10);
  n129 = bitcmp(bitor(n18, n12));
  n134 = bitand(n14, n60);
  n135 = bitand(n14, n60);
  n137 = n129;
  n208 = bitand(n41, n12);
  n211 = bitcmp(bitor(n137, n20));
  n230 = bitand(n135, n8);
  n238 = bitand(n12, n18);
  n254 = bitand(n14, n18);
  n304 = bitand(n41, n12);
  ...
  n1528 = bitcmp(bitand(n1290, bitand(n1277, n211)));
  n1529 = bitcmp(bitand(n1290, bitand(n1277, n211)));
