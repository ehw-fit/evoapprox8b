...
function [ c ] = mul8_391( a, b )
% Approximate function mul8_391
%  Library = EvoApprox8b
%  Circuit = mul8_391
%  Area   (180) = 6604
%  Delay  (180) = 4.630
...
%  EP = 95.4 %
  ...
  n34 = bitcmp(bitand(bitor(n26, n32), n14));
  n35 = bitcmp(bitand(bitor(n26, n32), n14));
  n38 = bitcmp(bitor(n6, bitor(n34, n26)));
  n39 = bitcmp(bitor(n6, bitor(n34, n26)));
  n41 = bitand(n18, n38);
  n46 = bitcmp(bitand(bitor(n18, n16), n41));
  n49 = bitcmp(n46);
  n50 = bitcmp(bitor(bitand(n39, n16), n39));
  n51 = bitcmp(bitor(bitand(n39, n16), n39));
  n54 = bitcmp(bitand(bitor(n50, n8), n51));
  n65 = bitor(n41, n38);
  n67 = bitor(n51, n12);
  n69 = bitcmp(n41);
  n74 = bitcmp(bitxor(n22, n24));
  ...
  n114 = bitand(n103, n54);
  n115 = bitand(n103, n54);
  n132 = bitand(n94, n16);
  n148 = bitand(n14, n16);
  n221 = n49;
  n232 = bitand(n8, n18);
