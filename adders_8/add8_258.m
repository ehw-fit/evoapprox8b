...
function [ c ] = add8_258( a, b )
% Approximate function add8_258
%  Library = EvoApprox8b
%  Circuit = add8_258
%  Area   (180) = 876
%  Delay  (180) = 1.610
...
%  EP = 43.8 %
  ...
  n32 = bitor(n0, n16);
  n53 = bitcmp(bitand(n0, bitand(n18, n16)));
  n58 = bitcmp(bitor(n53, n8));
  n62 = bitand(n2, n58);
  n82 = bitor(n2, n18);
  n132 = bitxor(bitxor(n4, n20), n62);
  n133 = bitor(bitor(bitand(n4, n20), bitand(n20, n62)), bitand(n4, n62));
