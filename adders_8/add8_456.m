...
function [ c ] = add8_456( a, b )
% Approximate function add8_456
%  Library = EvoApprox8b
%  Circuit = add8_456
%  Area   (180) = 856
%  Delay  (180) = 1.550
...
%  EP = 71.8 %
  ...
  n34 = bitcmp(bitor(n32, bitor(n10, n14)));
  n41 = bitcmp(bitand(n34, bitand(n2, n6)));
  n43 = bitcmp(bitor(bitand(n26, n18), n41));
  n82 = bitor(n2, n18);
  n100 = bitcmp(bitand(n4, n43));
  n132 = bitor(n4, n20);
