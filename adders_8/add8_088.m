...
%  EP = 70.3 %
  ...
  n33 = bitor(n12, n28);
  n35 = bitcmp(bitand(n18, bitand(n8, n14)));
  n37 = bitcmp(bitand(n4, n20));
  n39 = bitcmp(n37);
  n42 = n39;
  n46 = bitcmp(bitor(n18, bitor(n2, n12)));
  n50 = bitxor(n4, n20);
  n58 = bitxor(bitxor(n6, n22), n42);
  n59 = bitor(bitor(bitand(n6, n22), bitand(n22, n42)), bitand(n6, n42));
  n68 = bitxor(n8, n24);
  n69 = bitand(n8, n24);
  n77 = n68;
  n78 = bitxor(n10, n26);
