...
function [ c ] = add8_255( a, b )
% Approximate function add8_255
%  Library = EvoApprox8b
%  Circuit = add8_255
%  Area   (180) = 784
%  Delay  (180) = 1.470
...
%  EP = 71.5 %
  ...
  n33 = bitcmp(bitand(n0, bitand(n4, n18)));
  n35 = bitcmp(bitor(n33, n28));
  n41 = bitcmp(bitand(n35, bitand(n2, n20)));
  n43 = bitcmp(bitor(n41, n12));
  n82 = bitor(n2, n18);
  n132 = bitor(n4, n20);
  ...
  c = bitor(c, bitshift(bitand(n41, 1), 0));
