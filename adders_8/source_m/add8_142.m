...
function [ c ] = add8_142( a, b )
% Approximate function add8_142
%  Library = EvoApprox8b
%  Circuit = add8_142
%  Area   (180) = 880
%  Delay  (180) = 1.470
...
%  EP = 87.5 %
  ...
  n35 = bitcmp(bitxor(n2, n2));
  n43 = bitcmp(bitor(n18, bitor(n34, n4)));
  n60 = bitcmp(bitxor(n18, n18));
  n82 = bitor(n35, n4);
  n100 = n60;
  n101 = n60;
  n132 = bitor(bitand(n30, n101), bitand(bitcmp(n30), n4));
