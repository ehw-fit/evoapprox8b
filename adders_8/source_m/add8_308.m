...
%  EP = 43.8 %
  ...
  n32 = bitor(n0, n16);
  n38 = bitcmp(bitor(n14, bitor(n26, n30)));
  n53 = bitcmp(bitand(n38, bitand(n18, n16)));
  n59 = bitcmp(bitor(n53, bitor(n12, n4)));
  n77 = bitcmp(bitand(n59, bitand(n0, n2)));
  n81 = bitcmp(bitor(n20, bitor(n77, n28)));
  n82 = bitor(n2, n18);
