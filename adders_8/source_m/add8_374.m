...
%  EP = 43.8 %
  ...
  n32 = bitor(n0, n16);
  n39 = bitcmp(bitor(n14, bitor(n24, n30)));
  n52 = bitcmp(bitand(n39, bitand(n18, n16)));
  n59 = bitcmp(bitor(n52, n12));
  n77 = bitcmp(bitand(n59, bitand(n0, n2)));
  n80 = bitcmp(bitor(n8, bitor(n77, n28)));
  n82 = bitor(n2, n18);
  n132 = bitxor(bitxor(n4, n20), n80);
  n133 = bitor(bitor(bitand(n4, n20), bitand(n20, n80)), bitand(n4, n80));
