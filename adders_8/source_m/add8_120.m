...
%  EP = 43.8 %
  ...
  n32 = bitor(n0, n16);
  n39 = bitcmp(bitor(n26, bitor(n14, n28)));
  n52 = bitcmp(bitand(n39, bitand(n18, n16)));
  n63 = bitcmp(bitor(bitand(n10, n12), n52));
  n77 = bitcmp(bitand(n0, bitand(n63, n2)));
  n83 = bitor(n2, n18);
  n127 = bitcmp(n77);
  n132 = bitxor(bitxor(n4, n20), n127);
  n133 = bitor(bitor(bitand(n4, n20), bitand(n20, n127)), bitand(n4, n127));
