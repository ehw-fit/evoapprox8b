...
%  EP = 43.8 %
  ...
  n33 = bitor(n0, n16);
  n38 = bitcmp(bitor(n14, bitor(n28, n30)));
  n52 = bitcmp(bitand(n38, bitand(n18, n16)));
  n58 = bitcmp(bitor(n52, n12));
  n76 = bitcmp(bitand(n58, bitand(n0, n2)));
  n80 = bitcmp(bitor(n26, n76));
  n83 = bitor(n2, n18);
