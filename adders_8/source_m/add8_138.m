...
%  EP = 71.8 %
  ...
  n32 = bitcmp(bitand(n20, bitand(n4, n16)));
  n34 = bitcmp(bitor(n32, bitor(n6, n10)));
  n41 = bitcmp(bitand(n34, bitand(n18, n2)));
  n43 = bitcmp(bitor(n12, bitor(n24, n41)));
  n82 = bitor(n2, n18);
