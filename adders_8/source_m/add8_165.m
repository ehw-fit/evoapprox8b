...
function [ c ] = add8_165( a, b )
% Approximate function add8_165
%  Library = EvoApprox8b
%  Circuit = add8_165
%  Area   (180) = 856
%  Delay  (180) = 1.560
...
%  EP = 71.8 %
  ...
  n34 = bitcmp(bitor(n32, bitor(n28, n14)));
  n41 = bitcmp(bitand(n34, bitand(n6, n2)));
  n43 = bitcmp(bitor(bitand(n10, n18), n41));
  n82 = bitor(n2, n18);
