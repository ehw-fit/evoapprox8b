...
function [ c ] = add8_184( a, b )
% Approximate function add8_184
%  Library = EvoApprox8b
%  Circuit = add8_184
%  Area   (180) = 844
%  Delay  (180) = 1.530
...
%  EP = 71.7 %
  ...
  n33 = bitcmp(bitand(n20, bitand(n4, n2)));
  n34 = bitcmp(bitor(n33, bitor(n30, n12)));
  n40 = bitcmp(bitand(n34, n18));
  n42 = bitcmp(bitor(bitand(n14, n4), n40));
  n43 = bitcmp(bitor(bitand(n14, n4), n40));
  n82 = bitor(n2, n18);
  n100 = bitcmp(bitand(n0, n42));
  n132 = bitor(n4, n20);
