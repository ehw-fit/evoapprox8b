...
function [ c ] = add8_254( a, b )
% Approximate function add8_254
%  Library = EvoApprox8b
%  Circuit = add8_254
%  Area   (180) = 948
%  Delay  (180) = 1.780
...
%  EP = 43.8 %
  ...
  n32 = bitor(n0, n16);
  n39 = bitcmp(bitor(n14, bitor(n10, n30)));
  n77 = bitcmp(bitand(n18, bitand(n39, n2)));
  n81 = bitcmp(bitor(n28, bitor(n77, n22)));
  n82 = bitor(n2, n18);
