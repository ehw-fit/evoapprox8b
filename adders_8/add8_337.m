...
function [ c ] = add8_337( a, b )
% Approximate function add8_337
%  Library = EvoApprox8b
%  Circuit = add8_337
%  Area   (180) = 908
%  Delay  (180) = 1.750
...
%  EP = 43.8 %
  ...
  n58 = bitcmp(bitor(n52, n30));
  n82 = bitor(n2, n18);
  n132 = bitxor(bitxor(n4, n20), n58);
  n133 = bitor(bitor(bitand(n4, n20), bitand(n20, n58)), bitand(n4, n58));
