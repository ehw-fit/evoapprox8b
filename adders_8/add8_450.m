...
%  EP = 43.8 %
  ...
  n32 = bitor(n0, n16);
  n52 = bitcmp(bitand(n4, bitand(n18, n0)));
  n58 = bitcmp(bitor(n52, n14));
  n61 = bitand(n16, n58);
  n82 = bitor(n2, n18);
  n90 = bitand(n2, n61);
  n132 = bitxor(bitxor(n4, n20), n90);
  n133 = bitor(bitor(bitand(n4, n20), bitand(n20, n90)), bitand(n4, n90));
