...
%  EP = 62.5 %
  ...
  n50 = bitxor(n4, n20);
  n51 = bitand(n4, n20);
  n58 = bitxor(bitxor(n6, n22), n51);
  n59 = bitor(bitor(bitand(n6, n22), bitand(n22, n51)), bitand(n6, n51));
  n68 = bitxor(n8, n24);
  n69 = bitand(n8, n24);
  n77 = n68;
  n78 = bitxor(n10, n26);
  ...
  n423 = bitor(n97, n413);
  c = bitor(c, bitshift(bitand(n167, 1), 0));
