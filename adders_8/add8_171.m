...
function [ c ] = add8_171( a, b )
% Approximate function add8_171
%  Library = EvoApprox8b
%  Circuit = add8_171
%  Area   (180) = 772
%  Delay  (180) = 1.290
...
%  EP = 85.9 %
  ...
  n34 = bitcmp(bitor(n10, bitor(n14, n32)));
  n40 = bitxor(n20, n20);
  n53 = bitand(n4, n34);
  n126 = bitcmp(n40);
  n127 = bitcmp(n40);
  n132 = bitor(n4, n20);
  n182 = bitor(n6, n22);
  n232 = bitxor(bitxor(n8, n24), n53);
  n233 = bitor(bitor(bitand(n8, n24), bitand(n24, n53)), bitand(n8, n53));
