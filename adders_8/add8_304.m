...
function [ c ] = add8_304( a, b )
% Approximate function add8_304
%  Library = EvoApprox8b
%  Circuit = add8_304
%  Area   (180) = 884
%  Delay  (180) = 1.550
...
%  EP = 50.0 %
  ...
  n76 = bitcmp(bitand(n0, bitand(n16, n28)));
  n82 = bitxor(n2, n18);
  n83 = bitand(n2, n18);
  n112 = n83;
  n132 = bitxor(bitxor(n4, n20), n112);
  n133 = bitor(bitor(bitand(n4, n20), bitand(n20, n112)), bitand(n4, n112));
  n174 = n133;
