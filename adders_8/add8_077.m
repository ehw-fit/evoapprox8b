...
%  EP = 43.8 %
  ...
  n32 = bitor(n0, n16);
  n53 = bitcmp(bitand(n20, bitand(n18, n16)));
  n58 = bitcmp(bitor(n53, n14));
  n63 = bitand(n2, n58);
  n73 = bitand(n0, n63);
  n79 = n73;
  n83 = bitor(n2, n18);
  n132 = bitxor(bitxor(n4, n20), n79);
  n133 = bitor(bitor(bitand(n4, n20), bitand(n20, n79)), bitand(n4, n79));
