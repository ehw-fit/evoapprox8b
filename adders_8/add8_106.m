...
function [ c ] = add8_106( a, b )
% Approximate function add8_106
%  Library = EvoApprox8b
%  Circuit = add8_106
%  Area   (180) = 928
%  Delay  (180) = 1.550
...
%  EP = 25.0 %
  ...
  n83 = bitand(n2, n18);
  n114 = n83;
  n132 = bitxor(bitxor(n4, n20), n114);
  n133 = bitor(bitor(bitand(n4, n20), bitand(n20, n114)), bitand(n4, n114));
  n175 = n133;
  n182 = bitxor(bitxor(n6, n22), n175);
  n183 = bitor(bitor(bitand(n6, n22), bitand(n22, n175)), bitand(n6, n175));
