...
function [ c ] = add8_377( a, b )
% Approximate function add8_377
%  Library = EvoApprox8b
%  Circuit = add8_377
%  Area   (180) = 700
%  Delay  (180) = 1.090
...
%  EP = 85.9 %
  ...
  n33 = bitcmp(bitand(n22, bitand(n18, n6)));
  n40 = bitxor(n20, n20);
  n48 = bitcmp(bitor(n33, n14));
  n126 = bitcmp(n40);
  n127 = bitcmp(n40);
  n132 = bitor(n4, n20);
  n182 = bitor(n6, n22);
  n232 = bitxor(bitxor(n8, n24), n48);
  n233 = bitor(bitor(bitand(n8, n24), bitand(n24, n48)), bitand(n8, n48));
