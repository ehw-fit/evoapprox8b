...
function [ c ] = add8_236( a, b )
% Approximate function add8_236
%  Library = EvoApprox8b
%  Circuit = add8_236
%  Area   (180) = 888
%  Delay  (180) = 1.600
...
%  EP = 71.7 %
  ...
  n40 = bitcmp(bitand(n34, bitand(n18, n2)));
  n42 = bitcmp(bitor(n14, bitor(n30, n40)));
  n43 = bitcmp(bitor(n14, bitor(n30, n40)));
  n82 = bitor(n2, n18);
  n100 = bitcmp(bitand(n42, n20));
  n132 = bitor(n4, n20);
